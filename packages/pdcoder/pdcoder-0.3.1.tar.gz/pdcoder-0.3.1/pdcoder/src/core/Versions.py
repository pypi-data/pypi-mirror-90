...
class VersionManager(object):
    ...
    m_pkg_name = 'pdcoder'
    m_current_version = tuple('0.3.1'.split('.'))
    ...
    def start_update(self):
        ...
        import os
        os.system(
            'start pip install pdcoder -U  && python main.py && echo done;pause')
        # subprocess.Popen(
        #     'pip install pdcoder -U  && python main.py && echo done', shell=True)
        sys.exit(1)
