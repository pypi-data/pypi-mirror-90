"""
xUML_class_diagram.py – Generates an xumlzz diagram for an xumlzz model using the Flatland draw engine
"""
...
class XumlClassDiagram:
    ...
    def __init__(self, xuml_model_path: Path, flatland_layout_path: Path, diagram_file_path: Path):
        ...
        print("drawingzz a pretty diagram now. (Not really, but soon!)")
