...
from .xumlzz.xumlclassdiagramzz import XumlClassDiagram
...
def parse(cl_input):
    ...
    parser.add_argument('-m', '--model', action='store', default='model.xmm',
                        help='xumlzz model file name defining model connectivity without any layout information')
...
def main():
    ...
    # Generate the xumlzz class diagram (we don't do anything with the returned variable yet)
    ...
    # print("Initializing databasezz...")
    # import flatland.testszz.build_db_test

    print("Testing style databasezz...")
    import flatland.testszz.styledb_test
    print("No problemo")
