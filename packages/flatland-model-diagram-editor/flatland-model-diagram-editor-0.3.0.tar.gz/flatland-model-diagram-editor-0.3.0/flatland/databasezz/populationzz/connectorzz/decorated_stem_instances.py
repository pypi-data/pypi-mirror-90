...
population = [
    ...
    # xumlzz notation
    # Binary multiplicity
    {'Stem type': 'class mult', 'Diagram type': 'class', 'Notation': 'xumlzz',
     'Semantic': 'Mc mult', 'Stroke': 'normal'},
    {'Stem type': 'class mult', 'Diagram type': 'class', 'Notation': 'xumlzz',
     'Semantic': '1c mult', 'Stroke': 'normal'},
    {'Stem type': 'class mult', 'Diagram type': 'class', 'Notation': 'xumlzz',
    ...
    {'Stem type': 'associative mult', 'Diagram type': 'class', 'Notation': 'xumlzz',
     'Semantic': '1 mult', 'Stroke': 'dashed'},
    {'Stem type': 'associative mult', 'Diagram type': 'class', 'Notation': 'xumlzz',
     'Semantic': 'M mult', 'Stroke': 'dashed'},

    # Generalization
    {'Stem type': 'superclass', 'Diagram type': 'class', 'Notation': 'xumlzz',
     'Semantic': 'superclass', 'Stroke': 'normal'},
    ...
    {'Stem type': 'to state', 'Diagram type': 'state machine', 'Notation': 'xumlzz',
     'Semantic': 'target state', 'Stroke': 'normal'},

    # Both ends of unary stem are decoreated for xumlzz initial transition
    {'Stem type': 'to initial state', 'Diagram type': 'state machine', 'Notation': 'xumlzz',
     'Semantic': 'initial pseudo state', 'Stroke': 'normal'},
    {'Stem type': 'from deletion state', 'Diagram type': 'state machine', 'Notation': 'xumlzz',
    ...
    # xumlzz
    {'Stem type': 'to service', 'Diagram type': 'domain', 'Notation': 'xumlzz',
     'Semantic': 'require', 'Stroke': 'normal'}
]