...
population = [
    ...
    # xumlzz notation
    # Binary multiplicity
    {'Stem type': 'class mult', 'Diagram type': 'class', 'Notation': 'xumlzz', 'Semantic': 'Mc mult', 'Label': '0..*',
     'Default stem side': '+', 'Vertical stem offset': 9, 'Horizontal stem offset': 9},
    {'Stem type': 'class mult', 'Diagram type': 'class', 'Notation': 'xumlzz', 'Semantic': 'M mult', 'Label': '1..*',
     'Default stem side': '+', 'Vertical stem offset': 9, 'Horizontal stem offset': 9},
    {'Stem type': 'class mult', 'Diagram type': 'class', 'Notation': 'xumlzz', 'Semantic': '1c mult', 'Label': '0..1',
     'Default stem side': '+', 'Vertical stem offset': 9, 'Horizontal stem offset': 9},
    {'Stem type': 'class mult', 'Diagram type': 'class', 'Notation': 'xumlzz', 'Semantic': '1 mult', 'Label': '1',
     'Default stem side': '+', 'Vertical stem offset': 9, 'Horizontal stem offset': 9},

    # Associative multiplicity (no notation for 1 multiplicity associative)
    {'Stem type': 'associative mult', 'Diagram type': 'class', 'Notation': 'xumlzz', 'Semantic': 'M mult', 'Label': '{M}',
     'Default stem side': '+', 'Vertical stem offset': 9, 'Horizontal stem offset': 9},

    # Generalization
    {'Stem type': 'superclass', 'Diagram type': 'class', 'Notation': 'xumlzz', 'Semantic': 'superclass',
