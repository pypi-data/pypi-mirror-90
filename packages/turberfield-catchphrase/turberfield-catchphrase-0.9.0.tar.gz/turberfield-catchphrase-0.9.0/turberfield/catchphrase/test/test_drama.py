...
class DramaBuildShotsTests(unittest.TestCase):
...
class DramaMergeDialogueTests(unittest.TestCase):
    ...
    def test_append_simple(self):
        ...
        rv = Drama.safe_substitute(text, line)
        self.assertEqual(len(text) + len(line), len(rv), rv)
    ...
    def test_simple_format(self):
        ...
        line = "And another line"
        rv = Drama.safe_substitute(text, line)
        self.assertEqual(len(text) + len(line) - 3, len(rv), rv)
    ...
    def test_format_error(self):
        ...
        line = "And another line"
        rv = Drama.safe_substitute(text, line)
        self.assertEqual(len(text) + len(line) - 6, len(rv), rv)
