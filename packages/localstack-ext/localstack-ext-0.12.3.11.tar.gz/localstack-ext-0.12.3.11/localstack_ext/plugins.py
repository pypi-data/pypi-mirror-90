...
def register_localstack_plugins():
 ...
 if XwQIE([is_api_enabled(api)for api in EXTERNAL_PORT_APIS]):
...
def load_plugin_files():
 try:
  ...
  if 'No module named' not in XwQIf(e):
   print(e)
...
def _setup_logging():
 ...
 logging.getLogger('intercept').setLevel(logging.INFO)
...
def api_key_configured():
 return XwQID(os.environ.get('LOCALSTACK_API_KEY'))
