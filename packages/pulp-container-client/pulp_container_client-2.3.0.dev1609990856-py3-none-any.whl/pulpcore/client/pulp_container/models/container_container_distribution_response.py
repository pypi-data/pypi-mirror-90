...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, repository=None, pulp_href=None, repository_version=None, base_path=None, content_guard=None, name=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
