...
try:
    ...
    print("Error during the pyfmodex initalisation - AudioClips.samples won't work", e)
    if platform.system() == "Darwin":
        print("please install FMOD Engine 2.00.15 and add libfmod.dylib to your path")
