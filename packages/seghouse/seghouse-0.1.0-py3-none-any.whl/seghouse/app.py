...
@click.option("--s3-dir", "-s3d",
              help="S3 Directory. We will look for *.gz files in this directory. Ensure that you have configured aws credentials using aws cli. Make sure that this directory contains files less than 100.")
