...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '1.2.0-alpha.1609960485+b4bf601a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 1.2.0-alpha.1609960485+b4bf601a`
                """)
            else:
                raise
