    ...
    def get_repositories_metadata(self, category:Categories=None):
        ...
        for repo in repo_list:
            ...
            for model_path in models_list:
                ...
                repo_models.append(model_metadata)
            ...
            for dataset_path in datasets_list:
                ...
                repo_datasets.append(dataset_metadata)

            repo_metadata = RepositoryMetadata(repo.name, repo_models, num_models, repo_datasets, num_datasets)
