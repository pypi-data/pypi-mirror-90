...
class RepositoryMetadata():
    ...
    def __init__(self, name:str, models:list, num_models:int, datasets:list, num_datasets:int):
    ...
    def print_models(self):
        ...
        print("MODELS:")
        print(row_format.format(*['Index', 'Name', 'Category', 'Last Modification']))
        index = 0
        for model_metadata in self.models:
            print(row_format.format(*[index, model_metadata.name, model_metadata.category, model_metadata.last_modified]))
            index += 1
    ...
    def print_datasets(self):
        ...
        for dataset_metadata in self.datasets:
            print(row_format.format(*[index, dataset_metadata.name, dataset_metadata.category, dataset_metadata.last_modified]))
            index += 1
