...
with open("ModCog/README.md","r",encoding="utf-8") as fhandle:
  long_description=fhandle.read()

setuptools.setup(
    name="ModCog", #Package Name!
    version="0.0.1", # The version of your package!
    author="Famous8", # Your name here!
    author_email="discordpytools@ml.com", # Your e-mail here!
    description="", # A short description here!
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/Famous8/ModCog", # Link your package website here! (most commonly a GitHub repo)
