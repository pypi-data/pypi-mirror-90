...
if __name__ == '__main__':
    _db = SqlDataOp(label='160', db='xw_test', single_entity=True)
    # _db_1 = SqlDataOp('160', 'xw_test', single_entity=True)
    # print(id(_db))
    # print(id(_db_1))
