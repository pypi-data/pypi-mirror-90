...
class PushNotificationConfig(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"created_at",b"created_at",u"updated_at",b"updated_at"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"created_at",b"created_at",u"email",b"email",u"enabled",b"enabled",u"organization_id",b"organization_id",u"updated_at",b"updated_at",u"uri",b"uri"]) -> None: ...
...
class Settings(google___protobuf___message___Message):
    ...
    has_slack_integration: builtin___bool = ...

    def __init__(self,
        *,
        preferred_account_sources : typing___Optional[typing___Iterable[integration_source_pb2___IntegrationSourceValue]] = None,
        has_slack_integration : typing___Optional[builtin___bool] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"has_slack_integration",b"has_slack_integration",u"preferred_account_sources",b"preferred_account_sources"]) -> None: ...
