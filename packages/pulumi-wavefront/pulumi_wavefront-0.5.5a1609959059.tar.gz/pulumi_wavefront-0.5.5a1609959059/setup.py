...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.5.5-alpha.1609959059+19d9c44c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.5.5-alpha.1609959059+19d9c44c`
                """)
            else:
                raise
