...
# ------------------------------------------------------------------------------
name     = 'rc.connectivity'
mod_root = 'src/rc/connectivity/'
...
df = [('share/%s/examples' % name, glob.glob('examples/[01]*.py'))]
...
setup_args = {
    ...
    'version'            : version,
    'description'        : 'The RC I/O layer.',
  # 'long_description'   : (read('README.md') + '\n\n' + read('CHANGES.md')),
    'author'             : 'RADICAL-Consulting',
    'author_email'       : 'andre.merzky@radical-consulting.com',
    'maintainer'         : 'RADICAL-Consulting',
    'maintainer_email'   : 'devel@radical-consulting.com',
    'url'                : 'https://www.github.com/radical-consulting/rc.connectivity/',
    'license'            : 'LGPLV3 or commercial license',
    ...
    'package_dir'        : {'': 'src'},
    'scripts'            : [
                            'bin/rc-connectivity-version',
                            'bin/rc.sh.bootstrap.sh',
                            'bin/rc.sh.proxy.py',
                            'bin/rc.sh.py',
                           ],
