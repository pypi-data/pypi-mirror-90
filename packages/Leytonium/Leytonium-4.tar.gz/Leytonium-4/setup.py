...
setuptools.setup(
        ...
        py_modules = [],
        install_requires = ['aridity>=35', 'autopep8>=1.5.4', 'awscli>=1.18.133', 'lagoon>=17', 'PyGObject>=3.27.2', 'pytz>=2020.4', 'pyven>=56', 'PyYAML>=5.2', 'setuptools>=44.1.1', 'termcolor>=1.1.0'],
