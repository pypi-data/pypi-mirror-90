...
with open("pkg_upload/README.md","r",encoding="utf-8") as fhandle:
  long_description=fhandle.read()

setuptools.setup(
    name="pkg_upload", #Package Name!
    ...
    description="A package for uploading packages. Made with setuptools", # A short description here!
