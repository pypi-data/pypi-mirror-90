...
def download_dataflow(client: Client, data_service_id: str, dataflow_id: str, hostname: str, resource_base_path: str = "."):
  """
  ...
  rendered_dataflow, inline_code_list = render_dataflow(data_service_id, dataflow, hostname, dataflow_resource_path, resource_base_path)
...
def download_data_service(client: Client, data_service_id: str, hostname: str, resource_base_path: str = "."):
  """
...
_proto_mods = ["ascend", "component", "content_encoding", "core", "expression", "format", "function", "io", "operator", "pattern", "schema", "text"]
...
def _classname_map() -> dict:
  ...
  for defclass in ['DataService', 'Dataflow', 'ReadConnector', 'WriteConnector', 'Transform', 'ComponentGroup', 'DataFeed', 'DataFeedConnector']:
