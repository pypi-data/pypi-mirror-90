...
import orpg.orpg_version as orpg_version
from orpg.orpg_xml import bool_attrib, str_attrib
from .roles import *
...
class Player:
    def __init__(self, name):
        ...
        self._version = orpg_version.VERSION
        self._protocol_version = orpg_version.PROTOCOL_VERSION
        self._client_string = orpg_version.CLIENT_STRING
