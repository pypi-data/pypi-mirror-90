...
class WhiteboardCircle(WhiteboardObject):
    ...
    def takedom(self, xml_dom):
        self.centre.x = int_attrib(xml_dom, "x", 0)
        self.centre.y = int_attrib(xml_dom, "y", 0)
        self._radius = int_attrib(xml_dom, "r", 0)
        self._start_angle = float_attrib(xml_dom, "sa", 0.0)
        self._end_angle = float_attrib(xml_dom, "ea", 0.0)
        self.linecolor.Set(str_attrib(xml_dom, "color", "#FFFFFF"))
        self.linewidth = int_attrib(xml_dom, "width", 1)
        self._update_handles()
