...
class WhiteboardText(WhiteboardObject):
    ...
    def takedom(self, xml_dom):
        ...
        self.pos.x = int_attrib(xml_dom, "posx", 0)
        self.pos.y = int_attrib(xml_dom, "posy", 0)
        self.pointsize = int_attrib(xml_dom, "pointsize", 12)
        self.bold = bool_attrib(xml_dom, "bold", False)
        self.italic = bool_attrib(xml_dom, "italic", False)
        self.textcolor.Set(str_attrib(xml_dom, "color", "#FFFFFF"))
