    ...
    """
{
    ...
    "package_data": {
        "eks_spot_blocks._jsii": [
            "eks-spot-blocks@0.2.114.jsii.tgz"
        ],
        "eks_spot_blocks": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-ec2>=1.81.0, <2.0.0",
        "aws-cdk.aws-eks>=1.81.0, <2.0.0",
        "aws-cdk.aws-iam>=1.81.0, <2.0.0",
        "aws-cdk.aws-ssm>=1.81.0, <2.0.0",
        "aws-cdk.core>=1.81.0, <2.0.0",
        "awscdk-81-patch>=1.1.1, <2.0.0",
