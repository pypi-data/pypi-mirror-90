...
def meld_set_of_curves_to_family(set_of_curves: SetOfCurves) -> RawFamilyOfCurves:
    ...
    all_in_one = meld_along_columns(first_left, second_right, copy_at_meld=False, keep="first")
...
def _find_positions_in_between(
    ...
    left_2nd_guess_position = left_position - 1
    right_2nd_guess_position = right_position - 1
    left_2nd_guess_value = source_series.iloc[left_2nd_guess_position]
    right_2nd_guess_value = source_series.iloc[right_2nd_guess_position]
    if _target_is_in_between(left_2nd_guess_value, search_value, right_2nd_guess_value):
        return left_2nd_guess_position, right_2nd_guess_position
