...
def launch_parallel_containers(tests_dir, notebooks_dir, verbose=False, pdfs=None, reqs=None, 
    num_containers=None, image="taecoding/tae-grader", scripts=False, no_kill=False, output_path="./", 
...
def grade_assignments(tests_dir, notebooks_dir, id, image="taecoding/tae-grader", verbose=False, 
