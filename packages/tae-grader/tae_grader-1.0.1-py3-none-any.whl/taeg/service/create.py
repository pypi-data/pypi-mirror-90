"""
Database creation and setup for Taeg Service
"""
...
def create_users(filepath, host=None, username=None, password=None, conn=None):
    """
    Inserts usernames from ``filepath`` into Taeg Service's database
...
def main(args, conn=None, close_conn=True):
    """
    Creates Taeg Service database and tables
    ...
    try:
        ...
        cursor.execute('CREATE DATABASE taeg_db')
