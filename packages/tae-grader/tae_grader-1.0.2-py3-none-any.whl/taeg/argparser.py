"""
Argument parser for Taeg command-line tools
"""
...
PROG = ("taeg", "python3 -m taeg")[INVOKED_FROM_PYTHON]
...
def get_parser():
    """Creates and returns the argument parser for Taeg
    
    Returns:
        ``argparse.ArgumentParser``: the argument parser for Taeg command-line tools
    """
    ...
    Also supports use of Gradescope's autograding service, assignment distribution with taeg-assign, and public tests
    ...
    ##### PARSER FOR taeg assign #####
    assign_parser = subparsers.add_parser("assign", description="Create distribution versions of taeg-assign-formatted notebook")
    ...
    assign_parser.add_argument("--no-init-cell", help="Don't automatically generate an Taeg init cell", default=False, action="store_true")
    ...
    ##### PARSER FOR taeg generate autograder #####
    ...
    ##### PARSER FOR taeg generate token #####
    ...
    grade_parser.add_argument("--image", default="taeheejung/tae-grader", help="Custom docker image to run on")
    ...
    ###### PARSER FOR taeg service #####
    service_parser = subparsers.add_parser("service", description="Create and manage an taeg-service")
    service_subparsers = service_parser.add_subparsers()


    ##### PARSER FOR taeg service build #####
    service_build_parser = service_subparsers.add_parser("build", description="Build images for an taeg-service instance")
    ...
    service_build_parser.add_argument("--image", default="taeheejung/tae-grader", help="Based image for grading containers")
    ...
    ##### PARSER FOR taeg service create #####
    service_create_parser = service_subparsers.add_parser("create", description="Create database for taeg-service")
    ...
    ##### PARSER FOR taeg service start #####
    service_start_parser = service_subparsers.add_parser("start", description="Start an taeg-service instance")
