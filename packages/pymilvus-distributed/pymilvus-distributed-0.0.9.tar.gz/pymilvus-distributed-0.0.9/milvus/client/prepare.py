...
class Prepare:
    ...
    def describe_index_request(cls, collection_name, field_name):
        ...
        return service_msg_types.DescribeIndexRequest(collection_name, field_name)

    @classmethod
    def describe_index_progress_request(cls, collection_name, field_name):

        return service_msg_types.DescribeIndexProgressRequest(collection_name, field_name)
