...
class Prepare:
    ...
    def index_param(cls, collection_name, field_name, params):
        index_params = service_msg_types.IndexParam(collection_name=collection_name, field_name=field_name)
    ...
    def describe_index_request(cls, collection_name, field_name):
        ...
        return service_msg_types.DescribeIndexRequest(collection_name=collection_name, field_name=field_name)

    @classmethod
    def describe_index_progress_request(cls, collection_name, field_name):

        return service_msg_types.DescribeIndexProgressRequest(collection_name=collection_name, field_name=field_name)
