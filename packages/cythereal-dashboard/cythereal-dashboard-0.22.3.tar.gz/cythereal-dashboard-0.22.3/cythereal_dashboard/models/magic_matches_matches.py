...
class MagicMatchesMatches(object):
    ...
    def __init__(self, sha1=None, sha256=None, sha512=None, md5=None, object_class=None, unix_filetype=None, first_seen=None, filename=None, tags=None, status=None, analysis=None, is_public=None, is_owned=None, tokens=None, av_names=None, categories=None, labels=None, detection_stats=None, num_matches=None, match_type=None, match_subtypes=None, max_similarity=None):  # noqa: E501
