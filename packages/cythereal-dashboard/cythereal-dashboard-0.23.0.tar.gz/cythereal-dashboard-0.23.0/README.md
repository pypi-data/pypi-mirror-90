...
*DashboardApi* | [**add_binary**](docs/DashboardApi.md#add_binary) | **POST** /files/add/ | Add public binaries to your account
*DashboardApi* | [**create_file**](docs/DashboardApi.md#create_file) | **POST** /files/ | Upload a file for processing
*DashboardApi* | [**download_file**](docs/DashboardApi.md#download_file) | **GET** /files/{file_hash} | Download a file
...
*DashboardApi* | [**get_file_details**](docs/DashboardApi.md#get_file_details) | **GET** /files/{file_hash}/details | Get additional details about certain filetypes
*DashboardApi* | [**get_file_info**](docs/DashboardApi.md#get_file_info) | **GET** /files/{file_hash}/info/ | Get file info and analysis status
*DashboardApi* | [**get_file_status**](docs/DashboardApi.md#get_file_status) | **GET** /files/{file_hash}/status/ | Get processing status of the file.
...
*DashboardApi* | [**reprocess_file**](docs/DashboardApi.md#reprocess_file) | **GET** /files/{file_hash}/reprocess/ | Reprocess a previously uploaded file
