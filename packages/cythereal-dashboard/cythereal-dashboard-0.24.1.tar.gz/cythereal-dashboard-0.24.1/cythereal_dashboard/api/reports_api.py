...
class ReportsApi(object):
    ...
    def list_file_matches_for_group(self, file_hash, auth_key, **kwargs):  # noqa: E501
        """Retrieve the MAGIC matches for a binary.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_file_matches_for_group(file_hash, auth_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_file_matches_for_group_with_http_info(file_hash, auth_key, **kwargs)  # noqa: E501
        else:
            (data) = self.list_file_matches_for_group_with_http_info(file_hash, auth_key, **kwargs)  # noqa: E501
            return data

    def list_file_matches_for_group_with_http_info(self, file_hash, auth_key, **kwargs):  # noqa: E501
        """Retrieve the MAGIC matches for a binary.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_file_matches_for_group_with_http_info(file_hash, auth_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_file_matches_for_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'file_hash' is set
        if ('file_hash' not in params or
                params['file_hash'] is None):
            raise ValueError("Missing the required parameter `file_hash` when calling `list_file_matches_for_group`")  # noqa: E501
        # verify the required parameter 'auth_key' is set
        if ('auth_key' not in params or
                params['auth_key'] is None):
            raise ValueError("Missing the required parameter `auth_key` when calling `list_file_matches_for_group`")  # noqa: E501

        if 'file_hash' in params and not re.search(r'^([a-fA-F0-9]{32}|[a-fA-F0-9]{40}|[a-fA-F0-9]{64}|[a-fA-F0-9]{128})$', params['file_hash']):  # noqa: E501
            raise ValueError("Invalid value for parameter `file_hash` when calling `list_file_matches_for_group`, must conform to the pattern `/^([a-fA-F0-9]{32}|[a-fA-F0-9]{40}|[a-fA-F0-9]{64}|[a-fA-F0-9]{128})$/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/reports/{file_hash}/matches_for_group/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
