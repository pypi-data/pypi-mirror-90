...
*ReportsApi* | [**list_file_matches_for_group**](docs/ReportsApi.md#list_file_matches_for_group) | **POST** /reports/{file_hash}/matches_for_group/ | Retrieve the MAGIC matches for a binary.
