...
from tf_transformers.models import T5Encoder, EncoderDecoder
...
def T5Model(model_name, is_training=False, use_dropout = False, pipeline_mode=None, model_checkpoint_dir=None, encoder_sequence_length=None):
    """Wrapper for Model
