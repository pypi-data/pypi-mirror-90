...
from tf_transformers.layers.mask import CausalMask, SelfAttentionMask, prefix_mask, CrossAttentionMask
...
class AlbertEncoder(LegacyLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._embedding_layer, self._type_embeddings, self._position_embedding_layer = self.get_embedding_layers(self.embedding_projection_size)
        if self.is_decoder:
    ...
    def call_predict(self, inputs):
        ...
        #  past_length will be different for each entry) # noqa
        # if `sum(past_length) = 0` , means no outputs has been\
        #  generated. the given inputs is the first input # noqa
