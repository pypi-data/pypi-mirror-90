...
def convert_t5_hf_to_tf_transformers(model_hf, model_tf_transformers, config):
    ...
    mapping_dict["tf_mt5model/encoder/final_layer_norm/weight:0"] = "tf_transformers/m t5_encoder/last_layer_norm/weight:0"
    ...
    # Final Layer Norm weight
    mapping_dict["tf_mt5model/decoder/final_layer_norm/weight:0"] = "tf_transformers/mt5_decoder/last_layer_norm/weight:0"
    ...
    for original_var, legacy_var in mapping_dict.items():
        ...
        if "query/kernel:0" in legacy_var or "key/kernel:0" in legacy_var or "value/kernel:0" in legacy_var:
            ...
            assigned_map.append((original_var, legacy_var))
            continue
        if original_var == "tf_t5model/decoder/block_._0/layer_._1/EncDecAttention/relative_attention_bias/embeddings:0":
