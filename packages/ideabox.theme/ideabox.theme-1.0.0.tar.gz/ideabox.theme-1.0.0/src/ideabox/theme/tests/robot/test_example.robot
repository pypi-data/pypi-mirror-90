...
#
#  $ bin/test -s ideabox.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ideabox.theme.testing.IDEABOX_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ideabox/theme/tests/robot/test_example.robot
#
