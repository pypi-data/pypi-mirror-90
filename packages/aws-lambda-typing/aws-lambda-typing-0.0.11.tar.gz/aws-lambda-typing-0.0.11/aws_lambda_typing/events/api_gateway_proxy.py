...
class RequestContextIdentity(typing.TypedDict):
    """
...
class RequestContextV1(typing.TypedDict):
    """
    ...
    identity: :class:`RequestContextIdentity`
...
class APIGatewayProxyEventV1(typing.TypedDict):
    ...
    requestContext: :class:`RequestContextV1`
...
class RequestContextV2(typing.TypedDict):
    """
...
class APIGatewayProxyEventV2(typing.TypedDict):
    """
    ...
    requestContext: :class:`RequestContextV2`
