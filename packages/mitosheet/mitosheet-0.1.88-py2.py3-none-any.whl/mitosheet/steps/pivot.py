...
def execute_pivot_step(
    ...
    missing_pivot_keys = columns_used.difference(wsc.curr_step['column_metatype'][sheet_index].keys())
    ...
    # Create a new step
    wsc._create_and_checkout_new_step(PIVOT_STEP_TYPE)
    # Save the params of the current step
    wsc.curr_step['sheet_index'] = sheet_index
    wsc.curr_step['pivot_rows'] = pivot_rows
    wsc.curr_step['pivot_columns'] = pivot_columns
