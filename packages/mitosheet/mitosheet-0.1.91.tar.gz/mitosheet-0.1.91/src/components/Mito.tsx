...
class Mito extends React.Component<MitoProps, MitoState> {
    ...
    */
    ...
    constructor(props: MitoProps) {
        ...
        this.closeEditingTaskpane = this.closeEditingTaskpane.bind(this);
    ...
    */
    ...
    /* 
        Closes Editing Taskpanes and leaves other taskpanes open
    */ 
    ...
    /*
        ...
        When a column is moving, we set the movingColumnParams so we can send a reorder event to the backend
    */ 
    ...
    render() {
        ...
        return (
            <div className="mito-container" ref={(ref) => {this.mitoContainerRef = ref}}>
                <div className="mitosheet">
                    <MitoToolbar 
                        ...
                        setCurrOpenTaskpane={this.setCurrOpenTaskpane}
                        closeEditingTaskpane={this.closeEditingTaskpane}
                    />
                ...
                <SheetTabs
                    mitoContainerRef={this.mitoContainerRef}
                    send={this.props.send}
                    dfNames={this.state.dfNames}
