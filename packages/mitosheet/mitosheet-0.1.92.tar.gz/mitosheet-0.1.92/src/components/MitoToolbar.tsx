...
const MitoToolbar = (
    ...
    const contactSupport = () => {
        ...
        window.logger?.track({
            userId: window.user_id,
            event: 'button_talk_to_support',
        });

        // open calendly
        window.open("https://calendly.com/trymito/mito-early-access-demo?month=2021-01&utm_source=in-app-support", '_blank')
    }
