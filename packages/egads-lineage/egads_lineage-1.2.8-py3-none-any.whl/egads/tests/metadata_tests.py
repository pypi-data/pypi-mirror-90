...
class MetadataCreationTestCase(unittest.TestCase):
    ...
    def test_creation_of_metadata_object(self):
        ...
        self.assertEqual(file_metadata, TEST_GLOBAL_METADATA_DICT, 'Global metadata not properly assigned to file '
                                                                   'metadata instance')
        self.assertEqual(alg_metadata, TEST_ALGORITHM_METADATA_DICT, 'Algorithm metadata not properly assigned to '
                                                                     'algorithm metadata instance')
        self.assertEqual(variable_metadata, TEST_VARIABLE_METADATA_DICT, 'Variable metadata not properly assigned to '
                                                                         'variable metadata instance')
        self.assertEqual(file_metadata._conventions[0], TEST_GLOBAL_METADATA_DICT['Conventions'], 'Global metadata '
                                                                                                  'conventions object '
                                                                                                  'doesnt match')
