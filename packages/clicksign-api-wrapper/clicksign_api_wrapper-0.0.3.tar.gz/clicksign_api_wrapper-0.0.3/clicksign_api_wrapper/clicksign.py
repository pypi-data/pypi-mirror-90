...
from .exceptions import make_response
...
class ClickSign:
    ...
    def create_new_doc_from_template(self,
                                     template_key: str,
                                     doc_path: str,
                                     data: Dict,
                                     auto_close=True) -> Document:
    ...
    def create_new_doc_uploading_file(self,
                                      content_base64: str,
                                      doc_path: str,
                                      auto_close: bool = True) -> Document:
        """Create a new document from a file.
        Args:
            content_base64 (str): The file encoded in base64 with the mimetype Ex: 'data:<mimetype>;base64,<data>' The mimetype of the file. Should be in [application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document] 
            doc_path (str): The new document path (folder location and file name)
            auto_close (bool): If the document should be closed automatically
        Raises:
            BadRequest: Bad request, check your request
            Unauthorized: Invalid token
            Forbidden: You do not have permition to this resource. 
