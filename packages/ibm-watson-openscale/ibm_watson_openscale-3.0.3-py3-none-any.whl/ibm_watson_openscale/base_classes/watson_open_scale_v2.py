...
class DataMarts:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['data_mart_id']
        path_param_values = self.watson_open_scale.encode_path_vars(data_mart_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/data_marts/{data_mart_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class ServiceProviders:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['service_provider_id']
        path_param_values = self.watson_open_scale.encode_path_vars(service_provider_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/service_providers/{service_provider_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class Subscriptions:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['subscription_id']
        path_param_values = self.watson_open_scale.encode_path_vars(subscription_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/subscriptions/{subscription_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def schemas(self,
        ...
        **kwargs
        ...
        path_param_values = self.watson_open_scale.encode_path_vars(subscription_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/subscriptions/{subscription_id}/schemas'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       data=data)
    ...
    def score(self,
        ...
        **kwargs
        ...
        path_param_values = self.watson_open_scale.encode_path_vars(subscription_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/subscriptions/{subscription_id}/predictions'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       data=data)
...
class DataSets:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['data_set_id']
        path_param_values = self.watson_open_scale.encode_path_vars(data_set_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/data_sets/{data_set_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class Records:
    ...
    def add(self,
        ...
        **kwargs
        ...
        path_param_values = self.watson_open_scale.encode_path_vars(data_set_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/data_sets/{data_set_id}/records'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       params=params,
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['data_set_id', 'record_id']
        path_param_values = self.watson_open_scale.encode_path_vars(data_set_id, record_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/data_sets/{data_set_id}/records/{record_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers,
                                       params=params)
    ...
    def field(self,
        ...
        **kwargs
        ...
        path_param_keys = ['data_set_id', 'record_id', 'field_name']
        path_param_values = self.watson_open_scale.encode_path_vars(data_set_id, record_id, field_name)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/data_sets/{data_set_id}/records/{record_id}/{field_name}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class Requests:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['data_set_id', 'request_id']
        path_param_values = self.watson_open_scale.encode_path_vars(data_set_id, request_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/data_sets/{data_set_id}/requests/{request_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class Distributions:
    ...
    def add(self,
        ...
        **kwargs
        ...
        path_param_values = self.watson_open_scale.encode_path_vars(data_set_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/data_sets/{data_set_id}/distributions'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       params=params,
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['data_set_id', 'data_distribution_id']
        path_param_values = self.watson_open_scale.encode_path_vars(data_set_id, data_distribution_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/data_sets/{data_set_id}/distributions/{data_distribution_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class Monitors:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['monitor_definition_id']
        path_param_values = self.watson_open_scale.encode_path_vars(monitor_definition_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitor_definitions/{monitor_definition_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class Instances:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['monitor_instance_id']
        path_param_values = self.watson_open_scale.encode_path_vars(monitor_instance_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitor_instances/{monitor_instance_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers,
                                       params=params)
...
class Runs:
    ...
    def add(self,
        ...
        **kwargs
        ...
        path_param_values = self.watson_open_scale.encode_path_vars(monitor_instance_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitor_instances/{monitor_instance_id}/runs'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       data=data)
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['monitor_instance_id', 'monitoring_run_id']
        path_param_values = self.watson_open_scale.encode_path_vars(monitor_instance_id, monitoring_run_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitor_instances/{monitor_instance_id}/runs/{monitoring_run_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class Measurements:
    ...
    def add(self,
        ...
        **kwargs
        ...
        path_param_values = self.watson_open_scale.encode_path_vars(monitor_instance_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitor_instances/{monitor_instance_id}/measurements'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       data=data)
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['monitor_instance_id', 'measurement_id']
        path_param_values = self.watson_open_scale.encode_path_vars(monitor_instance_id, measurement_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitor_instances/{monitor_instance_id}/measurements/{measurement_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class Metrics:
    ...
    def list(self,
        ...
        **kwargs
        ...
        path_param_values = self.watson_open_scale.encode_path_vars(monitor_instance_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitor_instances/{monitor_instance_id}/metrics'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers,
                                       params=params)
...
class BusinessApplications:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['business_application_id']
        path_param_values = self.watson_open_scale.encode_path_vars(business_application_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/business_applications/{business_application_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class IntegratedSystems:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['integrated_system_id']
        path_param_values = self.watson_open_scale.encode_path_vars(integrated_system_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/integrated_systems/{integrated_system_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class OperationalSpaces:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['operational_space_id']
        path_param_values = self.watson_open_scale.encode_path_vars(operational_space_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/operational_spaces/{operational_space_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class UserPreferences:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['user_preference_key']
        path_param_values = self.watson_open_scale.encode_path_vars(user_preference_key)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/user_preferences/{user_preference_key}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
...
class ExplanationTasks:
    ...
    def get(self,
        ...
        **kwargs
        ...
        path_param_keys = ['explanation_task_id']
        path_param_values = self.watson_open_scale.encode_path_vars(explanation_task_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/explanation_tasks/{explanation_task_id}'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='GET',
                                       url=url,
                                       headers=headers,
                                       params=params)
...
class DriftService:
    ...
    def drift_archive_head(self,
        ...
        **kwargs
        ...
        path_param_values = self.watson_open_scale.encode_path_vars(monitor_instance_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitoring_services/drift/monitor_instances/{monitor_instance_id}/archives'.format(**path_param_dict)
    ...
    def drift_archive_post(self,
        ...
        **kwargs
        ...
        path_param_keys = ['data_mart_id', 'subscription_id']
        path_param_values = self.watson_open_scale.encode_path_vars(data_mart_id, subscription_id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/v2/monitoring_services/drift/data_marts/{data_mart_id}/subscriptions/{subscription_id}/archives'.format(**path_param_dict)
        request = self.watson_open_scale.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       params=params,
