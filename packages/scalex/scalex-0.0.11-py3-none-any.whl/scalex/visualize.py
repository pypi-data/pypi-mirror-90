...
def plot_legend(color_map, savefig=None, figsize=(0.1, 0.1), ncol=1, title='', marker='o'):
#     import matplotlib.patches as mpatches
    from matplotlib.lines import Line2D
    plt.figure(figsize=figsize)
    legend_TN = [Line2D([0], [0], color=color, label=c, marker=marker) for c,color in color_map.items()]
...
def plot_meta2(adata, use_rep='latent', color='celltype', batch='batch', color_map=None, figsize=(10, 10), cmap='Blues',
              batches=None, annot=False, savefig=None, cbar=True, keep=False, fontsize=8, vmin=0, vmax=1):
    """
    input: AnnData
    """
    meta = []
...
def plot_meta(adata, use_rep=None, color='celltype', batch='batch', colors=None, cmap='Blues', vmax=1, vmin=0, mask=True,
              annot=False, savefig=None, fontsize=8):
    """
    input: AnnData
    """
    meta = []
