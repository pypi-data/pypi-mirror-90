...
#
#  $ bin/test -s iaweb.mosaic -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src iaweb.mosaic.testing.IAWEB_MOSAIC_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/iaweb/mosaic/tests/robot/test_example.robot
#
