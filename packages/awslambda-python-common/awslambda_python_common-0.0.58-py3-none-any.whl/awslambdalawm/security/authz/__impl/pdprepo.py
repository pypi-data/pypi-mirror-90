...
class PdpRepo:
    ...
    def savePolicy(self, policy:Policy) -> None:
        ...
        policyDict[self.__policiesTablePolicyTypeFieldName] = self.__prefixKeyFieldValue(policy.policyType)
    ...
    def __policyDictToPolicy(self, policyDict:Dict) -> Policy:
        return ObjectUtil.fromDict(
            dictValue = {
                **policyDict,
                PdpRepo.__DEFAULT_ENTITY_URI_FIELD_NAME: self.__unprefixDdbKeyFieldValue(policyDict[self.__policiesTableEntityUriFieldName]),
                PdpRepo.__DEFAULT_POLICY_TYPE_FIELD_NAME: self.__unprefixDdbKeyFieldValue(policyDict[self.__policiesTablePolicyTypeFieldName]),
            },
            objectType = Policy
        )
