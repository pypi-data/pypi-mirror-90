(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[5540],{92390:(t,e,i)=>{"use strict";i(31206);var a=i(50856),s=i(28426),n=i(1265),r=i(78956),o=i(44583),l=i(72986),h=i(33367),d=i(21683),c=i(49684);i(10983);let u=null;class p extends((0,h.P)([l.z],s.H3)){static get template(){return a.d`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get properties(){return{hass:Object,historyData:{type:Object,value:null},names:Object,isLoadingData:Boolean,endTime:{type:Object},upToNow:Boolean,noSingle:Boolean}}_computeIsSingleLineChart(t,e){return!e&&t&&1===t.length}_computeIsEmpty(t,e){const i=!e||!e.timeline||!e.line||0===e.timeline.length&&0===e.line.length;return!t&&i}_computeIsLoading(t){return t&&!this.historyData}_computeEndTime(t,e){return e?new Date:t}}customElements.define("state-history-charts",b)},58763:(t,e,i)=>{"use strict";i.d(e,{vq:()=>l,_J:()=>h,Nu:()=>c});var a=i(29171),s=i(22311),n=i(91741);const r=["climate","humidifier","water_heater"],o=["temperature","current_temperature","target_temp_low","target_temp_high","hvac_action","humidity","mode"],l=(t,e,i,a,s=!1,n,r=!0)=>{let o="history/period";return i&&(o+="/"+i.toISOString()),o+="?filter_entity_id="+e,a&&(o+="&end_time="+a.toISOString()),s&&(o+="&skip_initial_state"),void 0!==n&&(o+="&significant_changes_only="+Number(n)),r&&(o+="&minimal_response"),t.callApi("GET",o)},h=(t,e,i,a)=>t.callApi("GET",`history/period/${e.toISOString()}?end_time=${i.toISOString()}&minimal_response${a?"&filter_entity_id="+a:""}`),d=(t,e)=>t.state===e.state&&(!t.attributes||!e.attributes||o.every((i=>t.attributes[i]===e.attributes[i]))),c=(t,e,i,l)=>{const h={},c=[];if(!e)return{line:[],timeline:[]};e.forEach((e=>{if(0===e.length)return;const r=e.find((t=>t.attributes&&"unit_of_measurement"in t.attributes));let o;r?o=r.attributes.unit_of_measurement:"climate"===(0,s.N)(e[0])||"water_heater"===(0,s.N)(e[0])?o=t.config.unit_system.temperature:"humidifier"===(0,s.N)(e[0])&&(o="%"),o?o in h?h[o].push(e):h[o]=[e]:c.push(((t,e,i)=>{const s=[],r=i.length-1;for(const n of i)s.length>0&&n.state===s[s.length-1].state||(n.entity_id||(n.attributes=i[r].attributes,n.entity_id=i[r].entity_id),s.push({state_localize:(0,a.D)(t,n,e),state:n.state,last_changed:n.last_changed}));return{name:(0,n.C)(i[0]),entity_id:i[0].entity_id,data:s}})(i,l,e))}));return{line:Object.keys(h).map((t=>((t,e)=>{const i=[];for(const t of e){const e=t[t.length-1],a=(0,s.N)(e),l=[];for(const e of t){let t;if(r.includes(a)){t={state:e.state,last_changed:e.last_updated,attributes:{}};for(const i of o)i in e.attributes&&(t.attributes[i]=e.attributes[i])}else t=e;l.length>1&&d(t,l[l.length-1])&&d(t,l[l.length-2])||l.push(t)}i.push({domain:a,name:(0,n.C)(e),entity_id:e.entity_id,states:l})}return{unit:t,identifier:e.map((t=>t[0].entity_id)).join(""),data:i}})(t,h[t]))),timeline:c}}},1265:(t,e,i)=>{"use strict";i.d(e,{Z:()=>a});const a=(0,i(76389).o)((t=>class extends t{static get properties(){return{hass:Object,localize:{type:Function,computed:"__computeLocalize(hass.localize)"}}}__computeLocalize(t){return t}}))}}]);
//# sourceMappingURL=chunk.5979ceb3ee2ded8d952b.js.map