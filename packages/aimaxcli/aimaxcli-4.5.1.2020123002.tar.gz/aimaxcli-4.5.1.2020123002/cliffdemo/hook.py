...
class Linked(Command):
    def __init__(self, app, app_args):
        super(Linked, self).__init__(app, app_args)

    def get_parser(self, prog_name):
        return self.auth_info_loader.filter_parser(super(Linked, self).get_parser(prog_name))

    def take_action(self, parsed_args):
        super(Linked, self).take_action(parsed_args)