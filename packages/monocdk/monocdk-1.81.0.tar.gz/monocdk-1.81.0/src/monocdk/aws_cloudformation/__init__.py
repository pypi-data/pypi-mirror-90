...
class CustomResourceProviderConfig:
    def __init__(self, *, service_token: builtins.str) -> None:
        """(experimental) Configuration options for custom resource providers.

        :param service_token: (experimental) The ARN of the SNS topic or the AWS Lambda function which implements this provider.
...
class CustomResourceProvider(
    ...
    """(experimental) Represents a provider for an AWS CloudFormation custom resources.
