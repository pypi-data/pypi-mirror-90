...
class DockerImageSource:
    def __init__(
        ...
        *,
        ...
        :param directory: (experimental) The directory containing the Docker image build instructions. This path is relative to the asset manifest location.
        :param docker_build_args: (experimental) Additional build arguments. Default: - No additional build arguments
        :param docker_build_target: (experimental) Target build stage in a Dockerfile with multiple build stages. Default: - The last stage in the Dockerfile
        :param docker_file: (experimental) The name of the file with build instructions. Default: "Dockerfile"
...
class FileSource:
    def __init__(
        ...
        *,
        ...
        :param path: (experimental) The filesystem object to upload. This path is relative to the asset manifest location.
        :param packaging: (experimental) Packaging method. Default: FILE
