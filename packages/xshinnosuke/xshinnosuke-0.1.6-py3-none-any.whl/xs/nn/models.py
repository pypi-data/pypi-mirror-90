import xs.nn
from xs.optim import get_optimizer
from xs.utils.common import GLOBAL, List, Tuple
import xs.nn.functional as F
import xs.nn.objectives
from xs.utils.toolkit import ProgressBar, format_time, SummaryProfile
import time
import pickle
import xs.utils.data as data
from collections import defaultdict
import xs.core.autograd
...
class Sequential(_Model):
    ...
    def compile(self, optimizer, loss, **kwargs):
        ...
        for layer in self._graph:
            ...
            next_layer = layer
        self.init_params()
        self.loss = xs.nn.objectives.get_objective(loss)
...
class Model(_Model):
    ...
    def compile(self, optimizer, loss, **kwargs):
        ...
        self._graph = xs.core.autograd.topological_sort(self.inputs, self.outputs)
