...
[boto3.ForecastQueryService 1.16.48](https://boto3.amazonaws.com/v1/documentation/api/1.16.48/reference/services/forecastquery.html#ForecastQueryService) service
compatible with
