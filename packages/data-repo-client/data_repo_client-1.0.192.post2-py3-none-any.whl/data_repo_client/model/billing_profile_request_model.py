...
class BillingProfileRequestModel(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, billing_account_id, profile_name, biller, *args, **kwargs):  # noqa: E501
        """BillingProfileRequestModel - a model defined in OpenAPI

        Args:
            id (UniqueIdProperty):
            billing_account_id (str): unique identifier of the billing account from Google
            profile_name (str): display name to be used for the profile;
            biller (str): either “direct” or the reseller of the sub-account that sends the bill (like “on_spend”)
