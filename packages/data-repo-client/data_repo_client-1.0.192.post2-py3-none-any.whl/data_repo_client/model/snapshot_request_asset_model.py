...
class SnapshotRequestAssetModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'asset_name': (ObjectNameProperty,),  # noqa: E501
            'root_values': ([str],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'root_values': 'rootValues',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_name, root_values, *args, **kwargs):  # noqa: E501
        """SnapshotRequestAssetModel - a model defined in OpenAPI

        Args:
            asset_name (ObjectNameProperty):
            root_values ([str]):
