...
class DRSChecksum(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, checksum, *args, **kwargs):  # noqa: E501
        """DRSChecksum - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): The digest method used to create the checksum. If left unspecified md5 will be assumed. possible values: md5                # most blob stores provide a checksum using this etag               # multipart uploads to blob stores sha256 sha512. [optional]  # noqa: E501
        """
