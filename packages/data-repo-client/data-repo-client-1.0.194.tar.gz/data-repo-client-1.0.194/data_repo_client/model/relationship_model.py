...
def lazy_import():
    ...
    globals()['RelationshipTermModel'] = RelationshipTermModel


class RelationshipModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            '_from': (RelationshipTermModel,),  # noqa: E501
            'to': (RelationshipTermModel,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, _from, to, *args, **kwargs):  # noqa: E501
        """RelationshipModel - a model defined in OpenAPI
