...
class UniqueIdProperty(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UniqueIdProperty - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Unique identifier for a dataset, snapshot, etc. .  # noqa: E501

        Keyword Args:
            value (str): Unique identifier for a dataset, snapshot, etc. .  # noqa: E501
