...
class ConfigFaultCountedModel(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'skip_for': (int,),  # noqa: E501
            'insert': (int,),  # noqa: E501
            'rate': (int,),  # noqa: E501
            'rate_style': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'skip_for': 'skipFor',  # noqa: E501
        'insert': 'insert',  # noqa: E501
        'rate': 'rate',  # noqa: E501
        'rate_style': 'rateStyle',  # noqa: E501
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ConfigFaultCountedModel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            skip_for (int): number of fault tests to skip before beginning fault insertion. [optional]  # noqa: E501
            insert (int): total number of times to insert the fault; -1 means insert forever. [optional]  # noqa: E501
            rate (int): insert a fault rate percent of the time. If rate is 100, the fault will always be inserted regardless of rate. . [optional]  # noqa: E501
            rate_style (str): fixed style means insert the fault; skip for rate-1; ... random style means randomly insert the fault with probability of 1:<rate> . [optional]  # noqa: E501
        """
