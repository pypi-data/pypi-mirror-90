...
def lazy_import():
    ...
    globals()['RepositoryStatusModelSystems'] = RepositoryStatusModelSystems


class RepositoryStatusModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'ok': (bool,),  # noqa: E501
            'systems': ({str: (RepositoryStatusModelSystems,)},),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, ok, systems, *args, **kwargs):  # noqa: E501
        """RepositoryStatusModel - a model defined in OpenAPI

        Args:
            ok (bool): status of this service
            systems ({str: (RepositoryStatusModelSystems,)}):
