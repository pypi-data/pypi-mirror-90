...
class IngestRequestModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'table': (ObjectNameProperty,),  # noqa: E501
            'path': (str,),  # noqa: E501
            'format': (str,),  # noqa: E501
            'load_tag': (str,),  # noqa: E501
            'max_bad_records': (int,),  # noqa: E501
            'ignore_unknown_values': (bool,),  # noqa: E501
            'csv_field_delimiter': (str,),  # noqa: E501
            'csv_quote': (str,),  # noqa: E501
            'csv_skip_leading_rows': (int,),  # noqa: E501
            'csv_allow_quoted_newlines': (bool,),  # noqa: E501
            'csv_null_marker': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'load_tag': 'load_tag',  # noqa: E501
        'max_bad_records': 'max_bad_records',  # noqa: E501
        'ignore_unknown_values': 'ignore_unknown_values',  # noqa: E501
        'csv_field_delimiter': 'csv_field_delimiter',  # noqa: E501
        'csv_quote': 'csv_quote',  # noqa: E501
        'csv_skip_leading_rows': 'csv_skip_leading_rows',  # noqa: E501
        'csv_allow_quoted_newlines': 'csv_allow_quoted_newlines',  # noqa: E501
        'csv_null_marker': 'csv_null_marker',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, table, path, format, *args, **kwargs):  # noqa: E501
        """IngestRequestModel - a model defined in OpenAPI

        Args:
            table (ObjectNameProperty):
            path (str): gs path to a file in a bucket accessible to data repo
            format (str):
        ...
        Keyword Args:
            ...
            load_tag (str): client-specified tag for a data or file load. If no id is specified, we use the string form of the job create time as the tag. . [optional]  # noqa: E501
            max_bad_records (int): max number of bad records to skip; applies to JSON and CSV. [optional]  # noqa: E501
            ignore_unknown_values (bool): skip extra data; applies to JSON and CSV. [optional] if omitted the server will use the default value of True  # noqa: E501
            csv_field_delimiter (str): field separator. [optional] if omitted the server will use the default value of ","  # noqa: E501
            csv_quote (str): quoting character. [optional] if omitted the server will use the default value of """  # noqa: E501
            csv_skip_leading_rows (int): number of header rows to skip. [optional]  # noqa: E501
            csv_allow_quoted_newlines (bool): [optional] if omitted the server will use the default value of True  # noqa: E501
            csv_null_marker (str): [optional] if omitted the server will use the default value of ""  # noqa: E501
        """
