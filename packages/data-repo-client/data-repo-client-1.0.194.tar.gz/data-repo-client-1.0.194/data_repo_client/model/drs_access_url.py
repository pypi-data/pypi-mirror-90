...
class DRSAccessURL(ModelNormal):
    ...
    def __init__(self, url, *args, **kwargs):  # noqa: E501
        """DRSAccessURL - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            headers ([str]): An optional list of headers to include in the HTTP request to `url`. These headers can be used to provide auth tokens required to fetch the object bytes.. [optional]  # noqa: E501
        """
