...
class SnapshotRequestQueryModel(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_name, query, *args, **kwargs):  # noqa: E501
        """SnapshotRequestQueryModel - a model defined in OpenAPI
