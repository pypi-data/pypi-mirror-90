...
class JobModel(object):
    ...
    def id(self, id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                id is not None and not re.search(r'[A-za-z0-9\-\/_]{22}', id)):  # noqa: E501
            raise ValueError(r"Invalid value for `id`, must be a follow pattern or equal to `/[A-za-z0-9\-\/_]{22}/`")  # noqa: E501
