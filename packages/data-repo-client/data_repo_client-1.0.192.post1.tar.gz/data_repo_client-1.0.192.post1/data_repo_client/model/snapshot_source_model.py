...
def lazy_import():
    ...
    globals()['DatasetSummaryModel'] = DatasetSummaryModel
    globals()['ObjectNameProperty'] = ObjectNameProperty


class SnapshotSourceModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'dataset': (DatasetSummaryModel,),  # noqa: E501
            'asset': (ObjectNameProperty,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, dataset, asset, *args, **kwargs):  # noqa: E501
        """SnapshotSourceModel - a model defined in OpenAPI

        Args:
            dataset (DatasetSummaryModel):
            asset (ObjectNameProperty):
