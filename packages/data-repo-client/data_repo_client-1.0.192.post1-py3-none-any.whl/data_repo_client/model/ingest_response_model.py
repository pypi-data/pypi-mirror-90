...
class IngestResponseModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'dataset_id': (UniqueIdProperty,),  # noqa: E501
            'dataset': (ObjectNameProperty,),  # noqa: E501
            'load_tag': (str,),  # noqa: E501
            'bad_row_count': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'bad_row_count': 'bad_row_count',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, table, path, row_count, *args, **kwargs):  # noqa: E501
        """IngestResponseModel - a model defined in OpenAPI

        Args:
            table (ObjectNameProperty):
            path (str):
            row_count (int): number of rows successfully ingested
        ...
        Keyword Args:
            ...
            dataset_id (UniqueIdProperty): [optional]  # noqa: E501
            dataset (ObjectNameProperty): [optional]  # noqa: E501
            ...
            bad_row_count (int): number of bad rows skipped. [optional]  # noqa: E501
        """
