...
def lazy_import():
    ...
    globals()['DirectoryDetailModel'] = DirectoryDetailModel
    globals()['FileDetailModel'] = FileDetailModel
    globals()['FileModelType'] = FileModelType
...
class FileModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'file_type': (FileModelType,),  # noqa: E501
            'file_detail': (FileDetailModel,),  # noqa: E501
            'directory_detail': (DirectoryDetailModel,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'directory_detail': 'directoryDetail',  # noqa: E501
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            file_id (str): Unique id of the filesystem object within the dataset. [optional]  # noqa: E501
            collection_id (str): Id of the dataset or snapshot directory describing the object. [optional]  # noqa: E501
            path (str): full path of the file in the dataset. [optional]  # noqa: E501
            size (int): Always present for files - the file size in bytes Present for directories in snapshots - sum of sizes of objects in a directory . [optional]  # noqa: E501
            checksums ([DRSChecksum]): Always present for files - checksums; always includes crc32c. May include md5. Present for directories in snapshots - see DRS spec for algorithm for combining checksums of underlying directory contents. . [optional]  # noqa: E501
            created (str): timestamp of object creation in RFC3339. [optional]  # noqa: E501
            description (str): Human readable description of the file. [optional]  # noqa: E501
            file_type (FileModelType): [optional]  # noqa: E501
            file_detail (FileDetailModel): [optional]  # noqa: E501
            directory_detail (DirectoryDetailModel): [optional]  # noqa: E501
        """
