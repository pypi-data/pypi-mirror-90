...
class DataDeletionGcsFileModel(ModelNormal):
    ...
    def __init__(self, path, *args, **kwargs):  # noqa: E501
        """DataDeletionGcsFileModel - a model defined in OpenAPI

        Args:
            path (str): a gs://path/to/a/file that can include a wildcard (*)

        Keyword Args:
            file_type (str): defaults to "csv", must be one of ["csv", ]  # noqa: E501
