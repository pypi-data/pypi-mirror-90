...
class UpgradeModel(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'upgrade_name': (str,),  # noqa: E501
            'upgrade_type': (str,),  # noqa: E501
            'custom_name': (str,),  # noqa: E501
            'custom_args': ([str],),  # noqa: E501
        }
    ...
    attribute_map = {
        'upgrade_name': 'upgradeName',  # noqa: E501
        'upgrade_type': 'upgradeType',  # noqa: E501
        'custom_name': 'customName',  # noqa: E501
        'custom_args': 'customArgs',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, upgrade_name, *args, **kwargs):  # noqa: E501
        """UpgradeModel - a model defined in OpenAPI

        Args:
            upgrade_name (str): Unique name for the upgrade

        Keyword Args:
            upgrade_type (str): Enumeration to allow different kinds upgrades. defaults to "custom", must be one of ["custom", ]  # noqa: E501
            ...
            custom_name (str): Name of custom upgrade to launch. Only used when upgradeType is custom.. [optional]  # noqa: E501
            custom_args ([str]): Array of string arguments to the custom upgrade. Only used when upgradeType is custom.. [optional]  # noqa: E501
        """

        upgrade_type = kwargs.get('upgrade_type', "custom")
