...
class SnapshotRequestRowIdTableModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'table_name': (ObjectNameProperty,),  # noqa: E501
            'columns': ([ObjectNameProperty],),  # noqa: E501
            'row_ids': ([UniqueIdProperty],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, table_name, columns, row_ids, *args, **kwargs):  # noqa: E501
        """SnapshotRequestRowIdTableModel - a model defined in OpenAPI

        Args:
            table_name (ObjectNameProperty):
            columns ([ObjectNameProperty]):
            row_ids ([UniqueIdProperty]):
