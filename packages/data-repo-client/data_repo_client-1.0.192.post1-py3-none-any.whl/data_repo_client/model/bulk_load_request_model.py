...
class BulkLoadRequestModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'profile_id': (UniqueIdProperty,),  # noqa: E501
            'load_tag': (str,),  # noqa: E501
            'load_control_file': (str,),  # noqa: E501
            'max_failed_file_loads': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'load_tag': 'loadTag',  # noqa: E501
        'load_control_file': 'loadControlFile',  # noqa: E501
        'max_failed_file_loads': 'maxFailedFileLoads',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, profile_id, load_tag, load_control_file, *args, **kwargs):  # noqa: E501
        """BulkLoadRequestModel - a model defined in OpenAPI

        Args:
            profile_id (UniqueIdProperty):
            load_tag (str): client-specified tag for a data or file load. If no id is specified, we use the string form of the job create time as the tag. 
            load_control_file (str): gs:// path to a text file in a bucket. The file must be accessible to the DR Manager. Each line of the file is interpreted as the JSON form of one BulkLoadFileModel. For example, one line might look like   '{ \"sourcePath\":\"gs:/bucket/path/file\", \"targetPath\":\"/target/path/file\" }'
        ...
        Keyword Args:
            ...
            max_failed_file_loads (int): max number of failed file loads before stopping. [optional]  # noqa: E501
        """
