...
class UserStatusInfo(ModelNormal):
    ...
    attribute_map = {
        'user_subject_id': 'userSubjectId',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_subject_id, user_email, enabled, *args, **kwargs):  # noqa: E501
        """UserStatusInfo - a model defined in OpenAPI

        Args:
            user_subject_id (str): user id
            user_email (str): user email
            enabled (bool): true if the user is enabled in ldap
