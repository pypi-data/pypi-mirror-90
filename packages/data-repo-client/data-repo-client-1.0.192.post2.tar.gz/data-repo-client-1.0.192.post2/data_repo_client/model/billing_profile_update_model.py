...
class BillingProfileUpdateModel(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, billing_account_id, description, *args, **kwargs):  # noqa: E501
        """BillingProfileUpdateModel - a model defined in OpenAPI

        Args:
            id (UniqueIdProperty):
            billing_account_id (str): Unique identifier of the billing account from Google
            description (str): Free text that describes the profile
