...
def lazy_import():
    ...
    globals()['BulkLoadFileState'] = BulkLoadFileState


class BulkLoadHistoryModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'target_path': (str,),  # noqa: E501
            'state': (BulkLoadFileState,),  # noqa: E501
            'file_id': (str,),  # noqa: E501
            'checksum_crc': (str,),  # noqa: E501
            'checksum_md5': (str,),  # noqa: E501
            'error': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'checksum_crc': 'checksumCRC',  # noqa: E501
        'checksum_md5': 'checksumMD5',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_path, target_path, *args, **kwargs):  # noqa: E501
        """BulkLoadHistoryModel - a model defined in OpenAPI

        Args:
            source_path (str): gs URL of the source file to load
            target_path (str): Full path within the dataset where the file should be placed. The path must start with /. 
        ...
        Keyword Args:
            ...
            state (BulkLoadFileState): [optional]  # noqa: E501
            file_id (str): The fileId of the loaded file; non-null if state is SUCCEEDED. [optional]  # noqa: E501
            checksum_crc (str): The checksum crc of the loaded file; non-null if state is SUCCEEDED. [optional]  # noqa: E501
            checksum_md5 (str): The checksum mD5 of the loaded file; non-null if state is SUCCEEDED. [optional]  # noqa: E501
            error (str): The error message if state is FAILED. [optional]  # noqa: E501
        """
