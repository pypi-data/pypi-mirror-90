...
class ShortIdProperty(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ShortIdProperty - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Unique identifier for a flights, jobs, etc. .  # noqa: E501

        Keyword Args:
            value (str): Unique identifier for a flights, jobs, etc. .  # noqa: E501
