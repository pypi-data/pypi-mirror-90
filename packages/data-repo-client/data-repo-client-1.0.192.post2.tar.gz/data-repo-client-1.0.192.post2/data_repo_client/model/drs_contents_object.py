...
class DRSContentsObject(ModelNormal):
    ...
    def __init__(self, name, *args, **kwargs):  # noqa: E501
        """DRSContentsObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): A DRS identifier of an `Object` (either a single blob or a nested bundle). If this ContentsObject is an object within a nested bundle, then the id is optional. Otherwise, the id is required.. [optional]  # noqa: E501
            drs_uri ([str]): A list of full DRS identifier URI paths that may be used to obtain the object. These URIs may be external to this DRS instance.. [optional]  # noqa: E501
            contents ([DRSContentsObject]): If this ContentsObject describes a nested bundle and the caller specified \"?expand=true\" on the request, then this contents array must be present and describe the objects within the nested bundle.. [optional]  # noqa: E501
        """
