...
def lazy_import():
    ...
    globals()['SnapshotRequestRowIdTableModel'] = SnapshotRequestRowIdTableModel


class SnapshotRequestRowIdModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'tables': ([SnapshotRequestRowIdTableModel],),  # noqa: E501
        }
    ...
    def __init__(self, tables, *args, **kwargs):  # noqa: E501
        """SnapshotRequestRowIdModel - a model defined in OpenAPI

        Args:
            tables ([SnapshotRequestRowIdTableModel]):
