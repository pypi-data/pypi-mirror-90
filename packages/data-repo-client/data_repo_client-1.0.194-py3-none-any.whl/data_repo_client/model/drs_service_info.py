...
class DRSServiceInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'license': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def __init__(self, version, *args, **kwargs):  # noqa: E501
        """DRSServiceInfo - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            title (str): Service name. [optional]  # noqa: E501
            description (str): Service description. [optional]  # noqa: E501
            contact ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Maintainer contact info. [optional]  # noqa: E501
            license ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): License information for the exposed API. [optional]  # noqa: E501
        """
