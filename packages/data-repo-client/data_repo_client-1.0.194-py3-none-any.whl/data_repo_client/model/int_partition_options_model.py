...
class IntPartitionOptionsModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'column': (ObjectNameProperty,),  # noqa: E501
            'min': (int,),  # noqa: E501
            'max': (int,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, column, min, max, interval, *args, **kwargs):  # noqa: E501
        """IntPartitionOptionsModel - a model defined in OpenAPI

        Args:
            column (ObjectNameProperty):
            min (int): The smallest value to partition within the target column. Any rows with a value smaller than this will be unpartitioned. 
            max (int): The largest value to partition within the target column. Any rows with a value larger than this will be unpartitioned. 
            interval (int): The size to use when dividing the partitioning range into \"buckets\". (max - min) / (this value) cannot be larger than 4,000. 
