...
class DatasetRequestModel(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, default_profile_id, schema, *args, **kwargs):  # noqa: E501
        """DatasetRequestModel - a model defined in OpenAPI

        Args:
            name (ObjectNameProperty):
            default_profile_id (UniqueIdProperty):
