...
def lazy_import():
    ...
    globals()['DataDeletionTableModel'] = DataDeletionTableModel


class DataDeletionRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'delete_type': (str,),  # noqa: E501
            'spec_type': (str,),  # noqa: E501
            'tables': ([DataDeletionTableModel],),  # noqa: E501
        }
    ...
    attribute_map = {
        'delete_type': 'deleteType',  # noqa: E501
        'spec_type': 'specType',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """DataDeletionRequest - a model defined in OpenAPI

        Args:

        Keyword Args:
            delete_type (str): defaults to "soft", must be one of ["soft", ]  # noqa: E501
            spec_type (str): defaults to "gcsFile", must be one of ["gcsFile", ]  # noqa: E501
            ...
            tables ([DataDeletionTableModel]): [optional]  # noqa: E501
        """

        delete_type = kwargs.get('delete_type', "soft")
        spec_type = kwargs.get('spec_type', "gcsFile")
