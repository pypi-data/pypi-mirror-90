...
def lazy_import():
    ...
    globals()['BulkLoadFileModel'] = BulkLoadFileModel
    globals()['UniqueIdProperty'] = UniqueIdProperty


class BulkLoadArrayRequestModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'load_array': ([BulkLoadFileModel],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'load_array': 'loadArray',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, profile_id, load_tag, load_array, *args, **kwargs):  # noqa: E501
        """BulkLoadArrayRequestModel - a model defined in OpenAPI
        ...
        Args:
            ...
            load_array ([BulkLoadFileModel]): Array files to load
