...
def lazy_import():
    ...
    globals()['ConfigFaultCountedModel'] = ConfigFaultCountedModel


class ConfigFaultModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'fault_type': (str,),  # noqa: E501
            'counted': (ConfigFaultCountedModel,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'fault_type': 'faultType',  # noqa: E501
        'counted': 'counted',  # noqa: E501
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ConfigFaultModel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            enabled (bool): If the fault is enabled, then is in effect. Fault points cause insert faults. Typical usage is that faults are disabled on system start and explicitly enabled by test code or via the setFault endpoint. . [optional]  # noqa: E501
            fault_type (str): A simple fault has no parameters. It is just enabled or disabled. This type of fault is typically used when the desired behavior of the fault is too complex for expression in the fault types and custom code is needed to get the right failure behavior. A counted fault is used to insert some number of faults in a pattern. See the ConfigFaultCountedModel for details. . [optional]  # noqa: E501
            counted (ConfigFaultCountedModel): [optional]  # noqa: E501
        """
