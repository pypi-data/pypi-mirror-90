...
def lazy_import():
    ...
    globals()['DRSAccessURL'] = DRSAccessURL


class DRSAccessMethod(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'access_url': (DRSAccessURL,),  # noqa: E501
    ...
    attribute_map = {
        'type': 'type',  # noqa: E501
        'access_url': 'access_url',  # noqa: E501
    ...
    def __init__(self, type, *args, **kwargs):  # noqa: E501
        """DRSAccessMethod - a model defined in OpenAPI

        Args:
            type (str): Type of the access method.
        ...
        Keyword Args:
            ...
            access_url (DRSAccessURL): [optional]  # noqa: E501
            access_id (str): An arbitrary string to be passed to the `/access` path to get an `AccessURL`. This must be unique per object. Note that at least one of `access_url` and `access_id` must be provided.. [optional]  # noqa: E501
            region (str): Name of the region in the cloud service provider that the object belongs to.. [optional]  # noqa: E501
        """
