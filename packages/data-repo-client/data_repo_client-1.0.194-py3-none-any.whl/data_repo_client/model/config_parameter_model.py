...
class ConfigParameterModel(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ConfigParameterModel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (str): Configuration parameters are always passed as strings and converted within the service. That keeps the JSON simple. Sending in specific types doesn't help much, because there still might be a mismatch between the type passed in and the type required. . [optional]  # noqa: E501
        """
