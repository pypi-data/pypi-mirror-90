...
from data_repo_client.exceptions import ApiTypeError, ApiValueError, ApiException
from data_repo_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DataRepositoryServiceApi()
        api_instance.get_access_url  # this is an instance of the class Endpoint
        api_instance.get_access_url()  # this invokes api_instance.get_access_url.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_access_url.callable or self.callable in this class
