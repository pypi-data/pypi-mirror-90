...
class PanelState(object):
    def __init__(self, inputDict: dict):
        ...
        self.ArmTypeChangedTime = Utils.ParseDate(inputDict["ArmTypeChangedTime"])
        ...
        self.AlarmStateTime = Utils.ParseDate(inputDict["AlarmStateTime"])
        ...
        self.ReceptionLevelChangedTime = Utils.ParseDate(inputDict.get("ReceptionLevelChangedTime"))
        self.PanelBatteryLevel = inputDict.get("PanelBatteryLevel")
        self.IsPanelOffline = inputDict.get("IsPanelOffline")
        self.IsPanelOfflineChangedTime = Utils.ParseDate(inputDict.get("IsPanelOfflineChangedTime"))
        self.IsZWaveEnabled = inputDict["IsZWaveEnabled"]
        self.IsZWaveEnabledChangedTime = Utils.ParseDate(inputDict["IsZWaveEnabledChangedTime"])
        self.IsMainPowerConnected = inputDict["IsMainPowerConnected"]
        self.IsMainPowerConnectedChangedTime = Utils.ParseDate(inputDict["IsMainPowerConnectedChangedTime"])
        ...
        self.HasLowBatteryChangedTime = Utils.ParseDate(inputDict["HasLowBatteryChangedTime"])
        ...
        self.SirensVolumeLevelDurationChangedTime = Utils.ParseDate(inputDict["SirensVolumeLevelDurationChangedTime"])
        self.IsInInstallationMode = inputDict["IsInInstallationMode"]
        self.IsInInstallationModeChangedTime = Utils.ParseDate(inputDict["IsInInstallationModeChangedTime"])
        self.IsInSignalStrengthTest = inputDict["IsInSignalStrengthTest"]
        self.IsInSignalStrengthTestChangedTime = Utils.ParseDate(inputDict["IsInSignalStrengthTestChangedTime"])
        ...
        self.FrtStateChangedTime = Utils.ParseDate(inputDict["FrtStateChangedTime"])
