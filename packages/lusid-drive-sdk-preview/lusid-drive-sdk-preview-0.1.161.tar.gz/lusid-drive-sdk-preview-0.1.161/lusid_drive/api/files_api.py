...
class FilesApi(object):
    ...
    def create_file_with_http_info(self, x_lusid_drive_filename, x_lusid_drive_path, content_length, body, **kwargs):  # noqa: E501
        ...
        if 'content_length' in local_var_params and local_var_params['content_length'] > 524288000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `content_length` when calling `create_file`, must be a value less than or equal to `524288000`")  # noqa: E501
        if 'content_length' in local_var_params and local_var_params['content_length'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `content_length` when calling `create_file`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        header_params['X-LUSID-SDK-Version'] = '0.1.161'
    ...
    def update_file_contents_with_http_info(self, id, content_length, body, **kwargs):  # noqa: E501
        ...
        if 'content_length' in local_var_params and local_var_params['content_length'] > 524288000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `content_length` when calling `update_file_contents`, must be a value less than or equal to `524288000`")  # noqa: E501
        if 'content_length' in local_var_params and local_var_params['content_length'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `content_length` when calling `update_file_contents`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
