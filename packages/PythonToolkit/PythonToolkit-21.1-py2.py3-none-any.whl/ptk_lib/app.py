...
class PTKApp(wx.App):
    ...
    def OnInit(self):
        ...
        splashscreen = wx.adv.SplashScreen(bmp, wx.adv.SPLASH_CENTRE_ON_SCREEN| wx.adv.SPLASH_NO_TIMEOUT, 10000, None, -1)
        splashscreen.Show()
    ...
    def ShowTips(self, override=False):
        ...
        if showtip or override:
            tp = wx.adv.CreateFileTipProvider( RESOURCE_DIR+"tips.txt", tip_n)
            showtip = wx.adv.ShowTip(None, tp, showtip)
    ...
    def GetConfig(self):
        ...
        """
        cfg = wx.FileConfig(localFilename=USERDIR+'options_py3')
        return cfg
