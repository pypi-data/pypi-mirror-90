...
allFiles = ['alphabetizequiz.py', 'bagels.py', 'birthdayparadox.py', 'bitmapmessage.py', 'blackjack.py',
'bouncingdots.py', 'bouncinglines.py', 'caesarcipher.py', 'caesarhacker.py', 'calendarmaker.py', 'carrotinabox.py',
'checkers.py', 'chohan.py', 'clickbait.py', 'coinflipsimulator.py', 'collatz.py', 'conwaysgameoflife.py',
...
'parkingvalet.py', 'pegsolitaire.py', 'periodictable.py', 'piglatin.py', 'powerballlottery.py', 'primenumbers.py',
'progressbar.py', 'railfencecipher.py', 'rainbow1.py', 'rainbow2.py', 'reversegam.py', 'rockpaperscissors.py',
