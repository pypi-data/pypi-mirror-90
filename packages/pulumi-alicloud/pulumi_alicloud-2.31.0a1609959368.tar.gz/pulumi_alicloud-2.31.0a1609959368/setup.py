...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.31.0-alpha.1609959368+f2ce1b60'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.31.0-alpha.1609959368+f2ce1b60`
                """)
            else:
                raise
