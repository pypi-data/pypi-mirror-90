...
class AppSyncTransformer(
    ...
    def __init__(
        ...
        *,
        ...
        post_cdk_transformers: typing.Optional[typing.Mapping[typing.Any, typing.Any]] = None,
        pre_cdk_transformers: typing.Optional[typing.Mapping[typing.Any, typing.Any]] = None,
        ...
        :param post_cdk_transformers: (experimental) Optional. Additonal custom transformers to run after the CDK resource generations. Mostly useful for deep level customization of the generated CDK CloudFormation resources. Default: undefined
        :param pre_cdk_transformers: (experimental) Optional. Additonal custom transformers to run prior to the CDK resource generations. Particularly useful for custom directives. Default: undefined
    ...
    def add_lambda_data_source_and_resolvers(
        ...
        *,
        ...
        return jsii.invoke(self, "addLambdaDataSourceAndResolvers", [function_name, id, lambda_function, options])
    ...
    def http_resolvers(
        ...
        :stability: experimental
        """
        return jsii.get(self, "httpResolvers")
