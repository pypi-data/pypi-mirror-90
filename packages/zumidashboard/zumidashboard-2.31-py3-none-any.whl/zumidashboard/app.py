...
def check_streaming_server():
    p = subprocess.Popen(
        ['sudo', 'bash', lib_dir + '/shell_scripts/check_port.sh', '9696'],
...
def view_logs():
    p = subprocess.Popen('sudo journalctl -u zumidashboard.service > /home/pi/Dashboard/debug/dashboard_log.log',
                         stdout=subprocess.PIPE, stderr=subprocess.STDOUT, shell=True)
    p.communicate()
    with open('/home/pi/Dashboard/debug/dashboard_log.log', 'r') as file_data:
        output = ""
