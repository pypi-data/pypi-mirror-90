...
class RichiesteVolantini:
    ...
    @classmethod
    def find(cls, dt_inizio_creazione: Optional[Union[datetime, str]] = None,
             dt_fine_creazione: Optional[Union[datetime, str]] = None,
             dt_inizio_ric: Optional[Union[datetime, str]] = None,
             dt_fine_ric:  Optional[Union[datetime, str]] = None) -> List['RichiesteVolantini']:
        try:
            ...
            if dt_inizio_creazione:
                inizio_creazione = datetime.datetime.strptime(dt_inizio_creazione, "%Y-%M-%d") \
                    if type(dt_inizio_creazione) == "datetime" else dt_inizio_creazione
