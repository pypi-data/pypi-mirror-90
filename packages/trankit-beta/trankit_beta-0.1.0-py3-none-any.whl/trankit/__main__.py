...
print('{}: Done. Writing predictions to {}\nProcessing time: {} seconds'.format(datetime.now(), pred_conllu,
                                                                                time() - start_time))
os.system("python trankit/utils/conll18_ud_eval.py -v {} {}".format(gold_conllu, pred_conllu))
