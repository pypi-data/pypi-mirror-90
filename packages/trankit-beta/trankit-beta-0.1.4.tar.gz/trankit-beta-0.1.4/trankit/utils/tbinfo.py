...
trainable_langs = {'sundanese', 'russian', 'portuguese', 'korean', 'afrikaans', 'uyghur', 'danish', 'sinhala', 'german',
                   'assamese', 'javanese', 'punjabi', 'lao', 'belarusian', 'malagasy', 'swahili', 'albanian', 'italian',
                   'malayalam', 'greek', 'bengali', 'kazakh', 'polish', 'latvian', 'azerbaijani', 'so', 'icelandic',
                   'norwegian', 'uzbek', 'sanskrit', 'estonian', 'romanian', 'khmer', 'hungarian', 'tamil', 'nepali',
                   'scottish', 'kannada', 'turkish', 'finnish', 'marathi', 'swedish', 'slovenian', 'burmese', 'persian',
                   'macedonian', 'hebrew', 'gujarati', 'esperanto', 'french', 'chinese', 'kyrgyz', 'mongolian',
                   'galician', 'catalan', 'japanese', 'basque', 'yi', 'sindhi', 'spanish', 'pashto', 'croatian',
                   'georgian', 'kurdish', 'bulgarian', 'hausa', 'oriya', 'thai', 'serbian', 'filipino', 'english',
                   'czech', 'vietnamese', 'sk', 'welsh', 'amharic', 'dutch', 'telugu', 'hindi', 'ukrainian',
                   'indonesian', 'urdu', 'xhosa', 'latin', 'oromo', 'armenian', 'lithuanian', 'breton', 'arabic',
                   'irish', 'bosnian', 'western'}
...
lang2treebank = {
    ...
    'simplified-chinese': 'UD_Simplified_Chinese-GSDSimp',
