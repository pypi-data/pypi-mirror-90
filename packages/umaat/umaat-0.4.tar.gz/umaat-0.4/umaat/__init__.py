...
def destroy(b):
  i=5
  print("Intialaising the Destruction sequence")
  while i!=0:
    print("Destruction of the list  in ",i)
    i=i-1
  b.clear()
  print("List has been cleared succesfully")
  print("Transferring to main program")
  for j in range(21):
    sys.stdout.write('\r')
...
def classs():
  d=abs(int(input("enter the number of unique classes present in your dataset")))
  if d!=0  and d!=1:
    b=[]
    for i in range(d):
    ...
    while '' or "" in b:
      for j in range(len(b)):
       if b[j]=="" or b[j]=='':
          print("enter the class again for replacing position",j)
          c=input("enter the class again for replacing the elment at position")
          if c!="" or c!='':
            b[j]=c
          else:
            print("classes are",b)
            ...
            c=input("enter the class again for replacing the elment at position")
    print("\nclasses are",b)
    print("\n If the user feels the entire list of classes is wrong ")
    print("\n Enter 1 below to restart the entire process ")
    print("\n To continue the process type any number other than 1")
