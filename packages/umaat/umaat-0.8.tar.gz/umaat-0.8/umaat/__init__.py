...
def destroy(b):
  ...
  print("Transferring to back to stage 1")
  for j in range(21):
    sys.stdout.write('\r')
...
def classs(f):
  ...
  if d!=0  and d!=1:
    ...
    print("\n Enter 1 below to restart the entire process of gathering the classes again ")
    print("\n Enter 0 to continue the process ")
    e.extend(f)
...
def Regressor_accuracy_test(X_train, X_test, y_train, y_test):
  ...
  display(df)
  print("\n Note: Incase if the values of the dependent variable y is continous then the preffered choice is to go ahead with Regression models as classification models might throw an error ")
  print("\n If incase the user wnats to exit the algorithm due to the above reason please enter the value 0 or 1 below")
