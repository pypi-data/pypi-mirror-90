...
setup(
  ...
  version = '2.7.22',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/wickerdevs/py-instaclient/archive/v2.7.22.tar.gz',    # I explain this later on
