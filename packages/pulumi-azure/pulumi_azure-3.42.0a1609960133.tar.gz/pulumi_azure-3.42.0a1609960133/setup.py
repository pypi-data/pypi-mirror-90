...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.42.0-alpha.1609960133+2be2bd5c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.42.0-alpha.1609960133+2be2bd5c`
                """)
            else:
                raise
