...
class ReadRequest:
    ...
    def get_resolved_effective_dating(self) -> typing.List[datetime.datetime]:
        if 'get_resolved_effective_dating' not in self.__cache:
            self.__cache['get_resolved_effective_dating'] = flatten_date_constraints(self.effective_dating)
        return self.__cache['get_resolved_effective_dating']

    def get_resolved_valid_dating(self) -> typing.List[datetime.datetime]:
        if 'get_resolved_valid_dating' not in self.__cache:
            self.__cache['get_resolved_valid_dating'] = flatten_date_constraints(self.valid_dating)
        return self.__cache['get_resolved_valid_dating']
