...
# source: bakplane/validate/validate.proto
...
FieldRules = _reflection.GeneratedProtocolMessageType('FieldRules', (_message.Message,), {
  ...
  '__module__' : 'bakplane.validate.validate_pb2'
