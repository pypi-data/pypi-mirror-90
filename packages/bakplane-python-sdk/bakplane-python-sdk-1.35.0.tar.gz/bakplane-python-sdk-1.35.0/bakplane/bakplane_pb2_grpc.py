...
class BakplaneServicer(object):
    ...
    def ApplyResource(self, request, context):
        """Apply a resource, a new resource is created
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def ResolveResourceIntent(self, request, context):
        ...
        and a big advantage are the results of entity resolution used to perform mapping to access the data you need
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
