...
[boto3.SagemakerEdgeManager 1.16.50](https://boto3.amazonaws.com/v1/documentation/api/1.16.50/reference/services/sagemaker-edge.html#SagemakerEdgeManager) service
compatible with
