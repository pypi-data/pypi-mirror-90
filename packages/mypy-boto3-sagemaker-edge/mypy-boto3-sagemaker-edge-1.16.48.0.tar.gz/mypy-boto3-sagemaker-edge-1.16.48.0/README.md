...
[boto3.SagemakerEdgeManager 1.16.48](https://boto3.amazonaws.com/v1/documentation/api/1.16.48/reference/services/sagemaker-edge.html#SagemakerEdgeManager) service
compatible with
