...
class Ui_EditorGeneralPage(object):
    def setupUi(self, EditorGeneralPage):
        ...
        EditorGeneralPage.resize(550, 700)
        ...
        self.gridLayout_3.addWidget(self.sourceOutlineWidthStepSpinBox, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.sourceOutlineShowCodingCheckBox, 2, 0, 1, 3)
        self.verticalLayout_4.addWidget(self.sourceOutlineGroupBox)
        ...
        EditorGeneralPage.setTabOrder(self.converttabsCheckBox, self.sourceOutlineGroupBox)
