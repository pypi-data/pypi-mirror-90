...
class Ui_QtPage(object):
    def setupUi(self, QtPage):
        ...
        QtPage.resize(556, 690)
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(QtPage)
        ...
        self.verticalLayout_6.addWidget(self.line12)
        ...
        self.pyqtToolsDirPicker = E5PathPicker(self.groupBox_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pyside2Group = QtWidgets.QGroupBox(QtPage)
        self.pyside2Group.setObjectName("pyside2Group")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.pyside2Group)
        ...
        self.verticalLayout_6.addWidget(self.pyside2Group)
        ...
        QtPage.setTabOrder(self.pyuicExecuteCheckBox, self.pyside2ToolsDirPicker)
...
"<p>Enter a postfix used to determine the Qt tool executable name. It is composed of the prefix, the tool name and the postfix. The executable extension is added automatically on Windows.</p>"))
        ...
        self.groupBox.setTitle(_translate("QtPage", "pyuic Options"))
