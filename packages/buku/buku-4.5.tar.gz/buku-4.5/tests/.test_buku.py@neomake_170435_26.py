...
@pytest.mark.parametrize('tags,data', [
    ...
    [',tag1,tag2,', '+ * [[htttp://example.com][Untitled]] :tag1:tag2:'],
    [',tag1 tag1,tag2,', '+ * [[htttp://example.com][Untitled]] :tag1_tag1:tag2:'],
])
def test_convert_bookmark_set_org_tags(tags, data):
    from buku import convert_bookmark_set
    bms = [
        (1, 'htttp://example.com', '', tags, '', 0),]
    res = convert_bookmark_set(bms, export_type='org')
