...
update_order = custom_integration.update_order
...
status_order = custom_integration.status_order
get_customer_profile = custom_integration.get_sso_customer_profile
update_shipping = custom_integration.foo()
