...
class Authentication:
    ...
    def authenticate(self):
        ...
        # data = {'grant_type': 'client_credentials', 'client_id': '68d148bf-ff54-4740-8bc1-f70d08b39bff',
        #         'client_secret': 'OFv97Npd8s6xObGx/VCzHfrHklq7MwCGdA11Bbdaq14='}
        # print(data)
        # print(constants.get_authentication_url())
        url = constants.get_authentication_url()
        _request = post(
            # url='https://api-dev.bsecure.app/v1/oauth/token',
            url=url,
            data=dumps(data),
            headers={
