...
async function resolveDependency(installSpecifier, packageSemver, lockfile, canRetry = true) {
    ...
    const { statusCode, headers, body } = await util_js_1.fetchCDNResource(installUrl);
    if (statusCode !== 200) {
        logger_1.logger.warn(`Failed to resolve [${statusCode}]: ${installUrl} (${body})`);
    ...
    if (installUrlType === 'pin') {
        ...
        await cacache_1.default.put(util_js_1.RESOURCE_CACHE, pinnedUrl, body, {
