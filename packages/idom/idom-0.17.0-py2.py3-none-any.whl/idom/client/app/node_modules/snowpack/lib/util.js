...
exports.DEV_DEPENDENCIES_DIR = path_1.default.join(exports.PROJECT_CACHE_DIR, 'dev');
...
function fetchCDNResource(resourceUrl, responseType) {
    ...
    return got_1.default(resourceUrl, {
...
async function openInBrowser(protocol, hostname, port, browser) {
    ...
    if (isMac && isOpeningInChrome) {
        ...
        browser === 'default' ? open_1.default(url) : open_1.default(url, { app: browser });
    }
}
