...
#
#  $ bin/test -s imioweb.core -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src imioweb.core.testing.IMIOWEB_CORE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/imioweb/core/tests/robot/test_example.robot
#
