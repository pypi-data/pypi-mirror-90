...
from notedrive.magnet.dht.node import Node
from notetool.tool.log import set_default_level

set_default_level(logging.DEBUG)
import random
from notedrive.magnet.dht.network import Server
from notedrive.magnet.dht.protocol import KRPCProtocol
from notedrive.magnet.dht.utils import digest
