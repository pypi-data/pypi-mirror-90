...
class Nodegroup(
    ...
    @jsii.python.classproperty # type: ignore
    @jsii.member(jsii_name="DEFAULT_INSTANCE_TYPES")
    def DEFAULT_INSTANCE_TYPES(cls) -> typing.List[aws_cdk.aws_ec2.InstanceType]:
        """(experimental) Default instanceTypes.

        :stability: experimental
        """
        return jsii.sget(cls, "DEFAULT_INSTANCE_TYPES")
