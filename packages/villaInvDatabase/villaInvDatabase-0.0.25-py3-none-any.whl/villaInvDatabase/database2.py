...
__all__ = ['PandasDataFrameAttribute', 'Database', 'updateWithDfs', 'lambdaPresignUpload', 'lambdaSingleBranchQuery',
           'lambdaAllBranchesQuery']
...
try:
  ...
  print(os.environ.get('DEFAULTCOLS'))
try:
...
def lambdaAllBranchesQuery(event, *args):
  ...
  ### conver to output format and upload to s3
  key = hashDict(body)
  path = '/tmp/tmpFile'
