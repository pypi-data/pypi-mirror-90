...
_STANDARDDISPLAYDATA_DISPLAYDATA = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      serialized_options=b'\242\264\372\302\005$beam:display_data:labelled_string:v1',
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
  containing_type=None,
...
LabelledStringPayload = _reflection.GeneratedProtocolMessageType('LabelledStringPayload', (_message.Message,), {
...
_STANDARDDISPLAYDATA_DISPLAYDATA.values_by_name["LABELLED_STRING"]._options = None
