...
copyright = "2004-2020 Kenneth J. Pronovici"
...
htmlhelp_basename = "CedarBackupV3Doc"
...
latex_documents = [(master_doc, "CedarBackup3.tex", "Cedar Backup v3 Documentation", "Kenneth J. Pronovici", "manual")]
...
man_pages = [(master_doc, "CedarBackup3", "Cedar Backup v3 Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "CedarBackup3",
        "Cedar Backup v3 Documentation",
        author,
        "CedarBackup3",
        "Implements local and remote backups to CD/DVD and Amazon S3",
        "Miscellaneous",
    )
]
