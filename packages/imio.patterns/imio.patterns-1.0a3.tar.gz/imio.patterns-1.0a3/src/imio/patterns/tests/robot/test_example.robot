...
#
#  $ bin/test -s imio.patterns -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src imio.patterns.testing.IMIO_PATTERNS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/imio/patterns/tests/robot/test_example.robot
#
