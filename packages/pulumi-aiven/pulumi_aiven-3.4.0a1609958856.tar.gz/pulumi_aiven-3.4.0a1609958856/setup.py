...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.4.0-alpha.1609958856+43ddbb01'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.4.0-alpha.1609958856+43ddbb01`
                """)
            else:
                raise
