...
class MertonJD_grid(svol_model):
    def __init__( self, series,dt, model, method,options ):
        ...
        self.workingpars_names=['mu','sigma','jumpintensity','jumpmean','jumpvolatility']
        self.workingpars=np.array([mu,sigma,jumpintensity,jumpmean,jumpvolatility])
        self.workingpars_diffs=[0.0001,0.0001,0.0001,0.0001, 0.0001]
...
# this alters self.working_pars, so make sure it's called after they are init'd
    ...
    def get_reportingpars(self):
        ...
        jumpintensity = self.workingpars[2]
        jumpmean = self.workingpars[3]
        jumpvolatility = self.workingpars[4]
...
#TODO: struct-ify?
            ...
            lncondprob_calc=lambda yasset,lncp: MertonJD_lncondassetprob(yasset,self.dt,mu,sigma,jumpintensity,jumpmean,jumpvolatility,lncp)
...
#        print(value,mu,sigma,jumpintensity,jumpmean,jumpvolatility)
#        print(value)
