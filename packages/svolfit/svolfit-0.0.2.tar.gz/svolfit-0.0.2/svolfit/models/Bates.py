...
# override/extend Heston defs
        ...
        self.workingpars_names=['mu','sigma','rho','alpha','xi','u0','jumpintensity','jumpmean','jumpvolatility']
        self.workingpars=np.array([mu,sigma,rho,alpha,xi,u0,jumpintensity,jumpmean,jumpvolatility])
...
# need to call this to get the super/super call happening...
        ...
        jumpintensity = self.workingpars[6]
        jumpmean = self.workingpars[7]
        jumpvolatility = self.workingpars[8]
...
#            u0=self.workingpars[5]
            ...
            if( CondProbCalc=='Limit' ):
                ...
                self.condprob_calc=lambda yasset,u_prev,u_this: Bates_condassetprob_limit(yasset,u_prev,u_this,dt,rho,sigma,coeff_dt,coeff_iu,coeff_du,jumpintensity,jumpmean,jumpvolatility)
...
#        ret['uT']=uT
    ...
    # switch consdasset prob calculation:
            ...
            if( CondProbCalc=='Limit' ):
                ...
                coeff_iu = rho*alpha*sigma/xi -sigma*sigma/2.0
                coeff_du = rho*sigma/xi
                self.condprob_calc=lambda yasset,u_prev,u_mid,u_this: Bates_condassetprob_limitX2(yasset,u_prev,u_mid,u_this,dt2,rho,sigma,coeff_dt,coeff_iu,coeff_du,jumpintensity,jumpmean,jumpvolatility)
...
#        ret['uT']=uT
    ...
    # switch consdasset prob calculation:
            ...
            lncondprob_calc=lambda yasset,u_prev,u_this,lncp: Bates_lncondassetprob(yasset,u_prev,u_this,self.dt,rho,sigma,mu,alpha,xi,jumpintensity,jumpmean,jumpvolatility,lncp)
