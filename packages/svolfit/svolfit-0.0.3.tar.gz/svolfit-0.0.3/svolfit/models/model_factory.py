...
from svolfit.models.GBM import GBM_grid
from svolfit.models.MertonJD import MertonJD_grid
from svolfit.models.PureJump import PureJump_grid
...
#    print(model,method)
    if( model == 'Template' ):
        ...
        if( method == 'analytic' ):
            modelobj = GBM_grid(series,dt, model, method,options)
        else:
        ...
        if( method == 'grid' ):
            modelobj = PureJump_grid(series,dt, model, method,options)
        else:
            print(model+' with unknown method: '+method)
...
#        if( method == 'tree' ):
#            modelobj = H32_tree(series,dt, model, method,options)
#        elif( method == 'treeX2' ):
#            modelobj = H32_treeX2(series,dt, model, method,options)
        if( method == 'grid' ):
...
#        if( method == 'tree' ):
#            modelobj = B32_tree(series,dt, model, method,options)
#        elif( method == 'treeX2' ):
#            modelobj = B32_treeX2(series,dt, model, method,options)
        if( method == 'grid' ):
...
#        if( method == 'tree' ):
#            modelobj = GARCHdiff_tree(series,dt, model, method,options)
#        elif( method == 'treeX2' ):
#            modelobj = GARCHdiff_treeX2(series,dt, model, method,options)
        if( method == 'grid' ):
...
#        if( method == 'tree' ):
#            modelobj = GARCHjdiff_tree(series,dt, model, method,options)
#        elif( method == 'treeX2' ):
#            modelobj = GARCHjdiff_treeX2(series,dt, model, method,options)
        if( method == 'grid' ):
