...
class GoogleCloudBuild(GoogleCloudPilotAPI):
    ...
    def make_source_repo_event(self, repo_name: str, branch_name: str, project_id: str = None):
    ...
    def make_github_event(self, url, branch_name: str = None, tag_name: str = None):
