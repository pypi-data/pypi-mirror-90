...
class PostBody:
    ...
    """
    Clase para contener todos los datos enviados durante una solicitud.
    p.ej. Los datos enviados desde formularios se almacenan aquí
    """
    __slots__ = 'data'
