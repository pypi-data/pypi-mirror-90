...
class ExperimentRunSummary(object):
    ...
    def __init__(self, average_run_seconds=None, error_runs=None, experiment_id=None, failed_runs=None, notstarted_runs=None, pending_runs=None, running_runs=None, succeeded_runs=None, terminated_runs=None, terminating_runs=None, local_vars_configuration=None):  # noqa: E501
