...
class ComponentRun(object):
    ...
    def __init__(self, component=None, end_time=None, experiment_run_id=None, id=None, inputs=None, outputs=None, run_context=None, start_time=None, status=None, local_vars_configuration=None):  # noqa: E501
