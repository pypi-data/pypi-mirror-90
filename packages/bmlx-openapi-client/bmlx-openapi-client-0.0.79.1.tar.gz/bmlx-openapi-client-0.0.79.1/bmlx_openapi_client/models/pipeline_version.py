...
class PipelineVersion(object):
    ...
    def __init__(self, commit_id=None, commit_msg=None, committer=None, create_time=None, dag=None, id=None, name=None, owner=None, package_checksum=None, package_uri=None, parameters=None, pipeline_id=None, pipeline_name=None, local_vars_configuration=None):  # noqa: E501
