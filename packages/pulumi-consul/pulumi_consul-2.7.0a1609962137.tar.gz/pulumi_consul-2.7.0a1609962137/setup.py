...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.7.0-alpha.1609962137+b6d9b2d1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.7.0-alpha.1609962137+b6d9b2d1`
                """)
            else:
                raise
