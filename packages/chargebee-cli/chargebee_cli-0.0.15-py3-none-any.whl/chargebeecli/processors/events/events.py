...
class Event(Processor, Validator, ResponseFormatter, Printer, Exporter):
    ...
    def format(self, __format, __operation):
        super().format(self.response, __format, __operation, self.headers, 'event', 'list')
        return self
    ...
    def delete(self, ctx, payload, resource_id):
        print('delete: operation is not supported for addresses')
        exit()
