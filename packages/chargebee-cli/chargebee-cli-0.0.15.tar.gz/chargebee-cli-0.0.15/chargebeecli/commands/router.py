...
from ..processors.gifts.gifts import Gift
...
@click.version_option("0.0.7 - python: 3.9")
@click.pass_context
def entry_point(ctx):
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def gift(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    Gift() \
        .validate_param(columns) \
        .process(None, operation, payload=None, resource_id=id) \
        .format(format, operation)
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def txn(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    Transaction() \
        .validate_param(columns) \
        .process(None, operation, payload=None, resource_id=id) \
        .format(format, operation)
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def hosted_pages(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    HostedPage() \
        .validate_param(columns) \
        .process(None, operation, payload=None, resource_id=id) \
        .format(format, operation)
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def quote(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    Quote() \
        .validate_param(columns) \
        .process(None, operation, payload=None, resource_id=id) \
        .format(format, operation)
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def coupon_set(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    CouponSet() \
        .validate_param(columns) \
        .process(None, operation, payload=None, resource_id=id) \
        .format(format, operation)
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def coupon_code(ctx, id, operation, columns, format, export_filename, export_format, export_path):
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def address(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    Address() \
        .validate_param(columns) \
        .process(None, operation, payload=None, resource_id=id) \
        .format(format, operation)
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def event(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    Event() \
        .validate_param(columns) \
        .process(None, operation, payload=None, resource_id=id) \
        .format(format, operation)
...
@click.option('--export-filename', "-efn", help='name of exported file', type=str)
@click.option('--export-path', "-ep", help='path where file to be exported', type=click.Path(exists=True))
def comment(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    Comment() \
        .validate_param(columns) \
        .process(None, operation, payload=None, resource_id=id) \
        .format(format, operation)
