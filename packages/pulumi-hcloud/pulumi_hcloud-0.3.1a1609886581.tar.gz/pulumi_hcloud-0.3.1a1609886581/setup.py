...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.3.1-alpha.1609886581+bd86ecc1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.3.1-alpha.1609886581+bd86ecc1`
                """)
            else:
                raise
