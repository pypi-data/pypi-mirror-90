...
from ..ignores import parse_ignore
...
def build_package():
    ...
    if not os.path.exists(SRC_PROJECT_FOLDER):
        print(f'Fatal: src project folder "{SRC_PROJECT_FOLDER}" not found.')
        exit()
