...
import kdsl.core.v1
import kdsl.storage.v1beta1_converters
...
class CSINode(K8sResource):
    ...
    spec: kdsl.storage.v1beta1.CSINodeSpec = attr.ib(
        metadata={"yaml_name": "spec"},
        converter=kdsl.storage.v1beta1_converters.required_converter_CSINodeSpec,
    )
...
class VolumeAttachmentStatus(K8sObject):
    ...
    attachError: Union[None, OmitEnum, kdsl.storage.v1beta1.VolumeError] = attr.ib(
        metadata={"yaml_name": "attachError"},
        converter=kdsl.storage.v1beta1_converters.optional_converter_VolumeError,
        default=OMIT,
    )
    attachmentMetadata: Union[None, OmitEnum, Mapping[str, str]] = attr.ib(
        metadata={"yaml_name": "attachmentMetadata"}, default=OMIT
    )
    detachError: Union[None, OmitEnum, kdsl.storage.v1beta1.VolumeError] = attr.ib(
...
class VolumeAttachmentStatusOptionalTypedDict(TypedDict, total=(False)):
    attachError: kdsl.storage.v1beta1.VolumeError
    attachmentMetadata: Mapping[str, str]
    detachError: kdsl.storage.v1beta1.VolumeError
...
class CSIDriverSpec(K8sObject):
    attachRequired: Union[None, OmitEnum, bool] = attr.ib(
        metadata={"yaml_name": "attachRequired"}, default=OMIT
    )
    podInfoOnMount: Union[None, OmitEnum, bool] = attr.ib(
        metadata={"yaml_name": "podInfoOnMount"}, default=OMIT
    )
    volumeLifecycleModes: Union[None, OmitEnum, Sequence[str]] = attr.ib(
        metadata={"yaml_name": "volumeLifecycleModes"}, default=OMIT
    )
...
class VolumeAttachment(K8sResource):
    ...
    spec: kdsl.storage.v1beta1.VolumeAttachmentSpec = attr.ib(
        metadata={"yaml_name": "spec"},
        converter=kdsl.storage.v1beta1_converters.required_converter_VolumeAttachmentSpec,
    )
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(
        metadata={"yaml_name": "metadata"},
        converter=kdsl.core.v1_converters.optional_converter_ObjectMeta,
    ...
    status: Union[
        None, OmitEnum, kdsl.storage.v1beta1.VolumeAttachmentStatus
    ] = attr.ib(
        metadata={"yaml_name": "status"},
        converter=kdsl.storage.v1beta1_converters.optional_converter_VolumeAttachmentStatus,
        default=OMIT,
    )
...
class CSIDriver(K8sResource):
    ...
    spec: kdsl.storage.v1beta1.CSIDriverSpec = attr.ib(
        metadata={"yaml_name": "spec"},
        converter=kdsl.storage.v1beta1_converters.required_converter_CSIDriverSpec,
    )
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(
        metadata={"yaml_name": "metadata"},
        converter=kdsl.core.v1_converters.optional_converter_ObjectMeta,
...
class VolumeAttachmentSpec(K8sObject):
    ...
    source: kdsl.storage.v1beta1.VolumeAttachmentSource = attr.ib(
        metadata={"yaml_name": "source"},
        converter=kdsl.storage.v1beta1_converters.required_converter_VolumeAttachmentSource,
    )
...
class VolumeAttachmentSpecTypedDict(TypedDict, total=(True)):
    attacher: str
    nodeName: str
    source: kdsl.storage.v1beta1.VolumeAttachmentSource
...
class CSINodeDriverItem(K8sObject):
    ...
    allocatable: Union[
        None, OmitEnum, kdsl.storage.v1beta1.VolumeNodeResources
    ] = attr.ib(
        metadata={"yaml_name": "allocatable"},
        converter=kdsl.storage.v1beta1_converters.optional_converter_VolumeNodeResources,
        default=OMIT,
    )
...
class CSINodeDriverItemOptionalTypedDict(TypedDict, total=(False)):
    allocatable: kdsl.storage.v1beta1.VolumeNodeResources
...
class CSINodeSpec(K8sObject):
    drivers: Mapping[str, kdsl.storage.v1beta1.CSINodeDriverItem] = attr.ib(
        metadata={"yaml_name": "drivers", "mlist_key": "name"},
        converter=kdsl.storage.v1beta1_converters.required_mlist_converter_CSINodeDriverItem,
    )
