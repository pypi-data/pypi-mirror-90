...
input data will be seperated to
  ...
  cascade(+):
    ...
    cascade_detail_initial_defect(?):
        starts with: "The Initial Defect Lattice Sites" or "The Initial Defect Atoms"
...
class CascadeDetailInitialDefect(BaseState):
    ...
    header2 = 'The Initial Defect Atoms'

    def startswith(self, line):
        return line == self.header1 or line == self.header2
...
class CascadeDetailInitialDefectAtom(CascadeBaseState):
    ...
    header1 = CascadeDetailInitialDefect.header2
