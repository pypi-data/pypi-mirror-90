  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx.post_execution_callbacks, branch_index, input, "Tout",
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "FakeParam", name, _ctx.post_execution_callbacks, "dtype", dtype,
        "shape", shape)
      return _result
    except _core._FallbackException:
      try:
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx.post_execution_callbacks, start, limit, delta, input,
        "body", body)
      return _result
    except _core._FallbackException:
      try:
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx.post_execution_callbacks, cond, input, "Tout", Tout,
...
def partitioned_call(args, Tout, f, config="", config_proto="", executor_type="", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "PartitionedCall", name, _ctx.post_execution_callbacks, args, "Tout",
...
def remote_call(target, args, Tout, f, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "RemoteCall", name, _ctx.post_execution_callbacks, target, args,
        "Tout", Tout, "f", f)
      return _result
    except _core._FallbackException:
      try:
...
def stateful_partitioned_call(args, Tout, f, config="", config_proto="", executor_type="", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "StatefulPartitionedCall", name, _ctx.post_execution_callbacks, args,
...
def stateless_if(cond, input, Tout, then_branch, else_branch, output_shapes=[], name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "StatelessIf", name, _ctx.post_execution_callbacks, cond, input,
...
def stateless_while(input, cond, body, output_shapes=[], parallel_iterations=10, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "StatelessWhile", name, _ctx.post_execution_callbacks, input, "cond",
...
def symbolic_gradient(input, Tout, f, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SymbolicGradient", name, _ctx.post_execution_callbacks, input,
        "Tout", Tout, "f", f)
      return _result
    except _core._FallbackException:
      try:
