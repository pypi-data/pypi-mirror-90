...
class InterpreterWrapper(_object):
    ...
    def TensorSizeSignature(self, i):
        return _tensorflow_wrap_interpreter_wrapper.InterpreterWrapper_TensorSizeSignature(self, i)

    def TensorSparsityParameters(self, i):
        return _tensorflow_wrap_interpreter_wrapper.InterpreterWrapper_TensorSparsityParameters(self, i)
    ...
    def TensorQuantizationParameters(self, i):
        return _tensorflow_wrap_interpreter_wrapper.InterpreterWrapper_TensorQuantizationParameters(self, i)
