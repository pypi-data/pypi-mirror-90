...
DEFAULTS_SETTINGS = {
    ...
    'data_download': {
        ...
        'user_models': 'bluedot_rest_framework.data_download.models.DataDownload',
        'user_serializers': 'bluedot_rest_framework.data_download.serializers.DataDownloadSerializer',
        'user_views': 'bluedot_rest_framework.data_download.views.DataDownloadView',
    },
    'wechat': {
        'miniprogram': {
            'APPID': '',
