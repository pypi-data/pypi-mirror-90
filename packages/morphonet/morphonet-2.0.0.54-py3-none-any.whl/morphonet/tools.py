...
def convertToOBJ(dataFull,t,background=0,factor=4,Smooth=True,Decimate=True,Reduction=True,center=[0,0,0],cells_updated=None,path_write=None): ####  CONVERT SEGMENTATION IN MESH 
        global _dataToConvert
