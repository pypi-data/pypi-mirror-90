...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.8.0-alpha.1609352477+4f655a7e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.8.0-alpha.1609352477+4f655a7e`
                """)
            else:
                raise
