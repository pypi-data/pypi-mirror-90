...
def main():
    ...
    parser.add_argument('--path_ASTRID', type=str, default=sitePackages + '/FASTRAL/ASTRID/ASTRID-'+sys, help='path to ASTRID | Default: linux runtime of ASTRID-2 (version untagged-fdc5326080d364b87c5a) is used (see: https://github.com/pranjalv123/ASTRID/releases/tag/untagged-fdc5326080d364b87c5a)', required = False)
