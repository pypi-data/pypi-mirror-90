...
- transition (boolean | number | string | dict | list; default 1000)
...
- persisted_props (list of a value equal to: 'selected', 'dot_source', 'engine', 'transition's; default ['selected', 'dot_source', 'engine', 'transition']): Properties whose user interactions will persist after refreshing the
