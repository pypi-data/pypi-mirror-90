...
def console_entry_point():
    ...
    Default: 'en_US'""")
    main_parser.set_defaults(execute=lambda args: execute_alis_fn('alis_defaults', args.device, args.root_pass, args.sec_locale))
...
There is some groups of packages:
    ...
    tools-packages = (google-chrome variety slack-desktop intellij-idea-ultimate-edition teamviewer)
    ''')
    ...
    Default: '4192' (It should be provided in bytes)""", default='4192')
