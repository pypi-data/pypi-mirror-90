...
from ..derived.fund_manager_processor_advanced import ManagerProcessor
...
class ManagerDailyCollectionProcessor:
    ...
    def __init__(self):
        self.classfy_helper = ManagerProcessor
    ...
    def cal(self):
        ...
        _df2 = result_df.set_index(['mng_id','fund_type'])[['best_fund','profit']]
        ...
        self.result = self.result.sort_values(['mng_id','fund_type','profit']).drop_duplicates(subset=['mng_id','fund_type'],keep='last')
