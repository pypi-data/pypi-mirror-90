...
class OSFundBenchmark(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    fund_name = Column(CHAR(255))  # 基金名称
    benchmark_1 = Column(CHAR(20)) # 基准1
    benchmark_2 = Column(CHAR(20)) # 基准2
    asset_type = Column(CHAR(20)) # 持仓类型
    pos_1 = Column(CHAR(64)) # 持仓信息 1
    pos_2 = Column(CHAR(64)) # 持仓信息 2
    pos_3 = Column(CHAR(64)) # 持仓信息 3
    pos_4 = Column(CHAR(64)) # 持仓信息 4
    pos_5 = Column(CHAR(64)) # 持仓信息 5
    pos_6 = Column(CHAR(64)) # 持仓信息 6
    pos_7 = Column(CHAR(64)) # 持仓信息 7
    pos_8 = Column(CHAR(64)) # 持仓信息 8
    pos_9 = Column(CHAR(64)) # 持仓信息 9
    pos_10 = Column(CHAR(64)) # 持仓信息 10
