        ...
        try:
            ...
            if not bond_list:
                ...
                if bond_list is None:
                    print('[em_conv_bond_clean_price] failed to get stock id list')
                    return False
    ...
    def em_conv_bond_dirty_price(self, start_date: str, end_date: str, bond_list: Tuple[str] = ()):
        try:
            ...
            if not bond_list:
                ...
                bond_list = self._em_sector_wrapper('617012', end_date)
                if bond_list is None:
                    print('[em_conv_bond_dirty_price] failed to get stock id list')
                    return False
...
if __name__ == '__main__':
    ...
    # em.em_stock_price('20021231', '20021231')
    # em.em_stock_post_price('20021231', '20021231')
    ...
    # em.em_conv_bond_clean_price('20140701', '20141231')
    # em.em_conv_bond_dirty_price('20140701', '20141231')