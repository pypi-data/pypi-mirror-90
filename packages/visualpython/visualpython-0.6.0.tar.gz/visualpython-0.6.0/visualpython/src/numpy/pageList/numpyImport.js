define([
    ...
    const { VP_ID_PREFIX, VP_CLASS_PREFIX, NUMPY_HTML_URL_PATH } = numpyConstData;
    ...
    var initOption = function(callback) {
        ...
        vpCommon.loadHtml(vpCommon.wrapSelector(VP_ID_PREFIX + vpConst.OPTION_GREEN_ROOM), NUMPY_HTML_URL_PATH, optionLoadCallback, callback);
    }
