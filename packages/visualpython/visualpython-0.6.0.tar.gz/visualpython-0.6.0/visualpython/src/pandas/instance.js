define([
    ...
    var initOption = function(callback, meta) {
        vpCommon.loadHtml(vpCommon.wrapSelector(vpCommon.formatString("#{0}", vpConst.OPTION_GREEN_ROOM)), "pandas/instance.html", optionLoadCallback, callback, meta);
    }
    ...
    VariablePackage.prototype.initHtml = function() {
        ...
        this.loadCss(Jupyter.notebook.base_url + vpConst.BASE_PATH + vpConst.STYLE_PATH + "pandas/instance.css");
