define([
    ...
    const DEF_BLOCK_ARG4_TYPE_EXCEPT_INPUT_STR = {
        NONE: 'none'
        , INT: 'int'
        , STR: 'str'
        , FLOAT: 'float'
    ...
    const WHILE_BLOCK_TYPE = {
        CONDITION: 'condition'
        , TRUE_FALSE: 'true false'
        , INFINITE_ROOP: 'infinite loop'
    }
    ...
    const VP_CLASS_APIBLOCK_BOARD_CONTAINER = 'vp-apiblock-left';
    const VP_CLASS_APIBLOCK_BOARD = 'vp-apiblock-board-body';
    const VP_CLASS_APIBLOCK_BUTTONS = 'vp-apiblock-right';
    ...
    const VP_CLASS_APIBLOCK_BOTTOM_TAB_VIEW = 'vp-apiblock-bottom-tab-view';
    ...
    const STATE_optionState = 'optionState';
    ...
    const STATE_forBlockOptionType = 'forBlockOptionType';
    const STATE_listforConditionList = 'listforConditionList';
    const STATE_listforReturnVar = 'listforReturnVar';
    const STATE_listforPrevExpression = 'listforPrevExpression';

    /** While */
    const STATE_whileCodeLine = 'whileCodeLine';
    const STATE_whileArgs = 'whileArgs';
    ...
    const STATE_commentLine = 'commentLine';

    /** Lambda */
    const STATE_lambdaArg1 = 'lambdaArg1';
    const STATE_lambdaArg2List = 'lambdaArg2List';
    const STATE_lambdaArg2m_List = 'lambdaArg2m_List';
    const STATE_lambdaArg3 = 'lambdaArg3';
    const STATE_lambdaArg4List = 'lambdaArg4List';
