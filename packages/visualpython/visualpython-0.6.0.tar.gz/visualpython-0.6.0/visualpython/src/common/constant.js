define ([
     ...
     */
    const HEADER_EXTRA_MENU_FAQ = VP_ID_PREFIX + 'extraMenuFAQ';

    /**
     * faq page link
     */
    const FAQ_PAGE_LINK = 'https://bl-vp.blogspot.com/p/faq.html';

    /**
     * header extra menu faq caption
     */
    const HEADER_EXTRA_MENU_FAQ_CAPTION = 'FAQ';
    /**
     ...
     */
    const ABOUT_PAGE_LINK = 'https://bl-vp.blogspot.com/p/about-visual-python.html';
    ...
    return {
        ...
        , HEADER_EXTRA_MENU_FAQ: HEADER_EXTRA_MENU_FAQ
        , HEADER_EXTRA_MENU_FAQ_CAPTION: HEADER_EXTRA_MENU_FAQ_CAPTION
        , FAQ_PAGE_LINK: FAQ_PAGE_LINK
