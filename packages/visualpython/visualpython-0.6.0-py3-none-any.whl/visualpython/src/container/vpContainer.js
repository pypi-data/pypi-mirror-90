define([
    ...
    var headerExtraMenuInit = function() {
        ...
        sbHeaderMenuPage.appendFormatLine('<li id="{0}">{1} <i class="{2}"></i></li>'
                        , vpConst.HEADER_EXTRA_MENU_FAQ, vpConst.HEADER_EXTRA_MENU_FAQ_CAPTION, 'fa fa-external-link');
        sbHeaderMenuPage.appendFormatLine('<li id="{0}">{1} <i class="{2}"></i></li>'
     ...
     */
    $(document).on("click", vpCommon.wrapSelector(vpCommon.formatString("#{0}", vpConst.HEADER_EXTRA_MENU_FAQ)), function() {
        // faq 페이지 열기
        window.open(vpConst.FAQ_PAGE_LINK);
        closeHeaderExtraMenu();
    });
     ...
     */
    $(document).on("input", vpCommon.wrapSelector(vpCommon.formatString(".{0}", vpConst.MANUAL_CODE_INPUT_AREA)), function() {
