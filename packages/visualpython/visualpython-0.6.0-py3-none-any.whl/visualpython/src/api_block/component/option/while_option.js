define([
    ...
    var InitWhileBlockOption = function(thatBlock, optionPageSelector) {
                ...
                var ifConditionListState = thatBlock.getState(STATE_whileConditionList);  
                ...
                ifConditionListState.forEach( ( condition, index ) => {
                    ...
                    */
                        ...
                        $(document).on(STR_CHANGE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid, function(event) {
                            ...
                            $(`.vp-block-header-${uuid}`).html(whileBlockCode);
                    ...
                    // WHILE_BLOCK_TYPE
                    // if (conditionType == WHILE_BLOCK_TYPE.CONDITION) {
                        for (var k = 1; k < 7; k++) {
                            ((i) => {
                                ...
                                /** If arg input 입력 변경 이벤트 함수 바인딩 */
                                    ...
                                    $(document).on(STR_CHANGE_KEYUP_PASTE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG +i+ index + uuid, function(event) {
                                        ...
                                        var ifConditionCode = GenerateWhileConditionList(thatBlock);
                                        $(`.vp-block-header-${thatBlock.getUUID()}`).html(ifConditionCode);
                    ...
                    // } else {
                        ...
                        // $(document).off(STR_CHANGE_KEYUP_PASTE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_USER_INPUT + index + uuid);
                        // $(document).on(STR_CHANGE_KEYUP_PASTE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_USER_INPUT + index + uuid, function(event) {
                        ...
                        // $(document).off(STR_CHANGE_KEYUP_PASTE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_6 + index + uuid);
                        // $(document).on(STR_CHANGE_KEYUP_PASTE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_6 + index + uuid, function(event) {
                ...
                $(document).on(STR_CLICK, vpCommon.wrapSelector(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_PLUS + uuid), function(event) {
                    ...
                    var newCondition = {
                        ...
                        , arg6: ''
                        // , arg7: ''
                        // , conditionType: WHILE_BLOCK_TYPE.CONDITION
                    }
                ...
                // $(document).off(STR_CLICK, vpCommon.wrapSelector(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_PLUS_USER_INPUT + uuid));
                // $(document).on(STR_CLICK, vpCommon.wrapSelector(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_PLUS_USER_INPUT + uuid), function(event) {
                ...
                //         codeLine: ''
                //         , arg6: ''
                //         , conditionType: WHILE_BLOCK_TYPE.TRUE_FALSE
                //     }
                //     ifConditionListState = CreateOneArrayValueAndGet(ifConditionListState, ifConditionListState.length, newCondition);
                //     thatBlock.setState({
                ...
                var bindSelectValueEventFunc_while = function(selectedValue, index, type) {
                    ...
                    if (type == WHILE_BLOCK_SELECT_VALUE_ARG_TYPE.ARG1) {
                        ...
                        // RenderSelectRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_1 + index + uuid, selectedValue);
                        ...
                        // RenderSelectRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid, selectedValue);
                    } else if (type == WHILE_BLOCK_SELECT_VALUE_ARG_TYPE.ARG3) {
                        updatedValue = {
                            ...ifConditionState
                            , arg3: selectedValue 
                        }
                        // RenderSelectRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_3 + index + uuid, selectedValue);
                        ...
                        // RenderSelectRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_6 + index + uuid, selectedValue);
                    }
                    ifConditionListState = UpdateOneArrayValueAndGet(ifConditionListState, index, updatedValue);
                    thatBlock.setState({
                        [STATE_whileConditionList]: ifConditionListState
                ...
                var renderThisComponent = function() {
                    ...
                    var optionContainerDom = MakeOptionContainer();
                    /* --------------------------- While ----------------------------- */
                    ...
                    ifConditionListState.forEach( (condition, index) => {
                        ...
                        var filterd_IF_OPERATOR_ARG2 = WHILE_OPERATOR_ARG2.filter(arg => {
                            if (arg == 'none') {
                                return false;
                            } else {
                                return true;
                        ...
                        var isSuggestInput = filterd_IF_OPERATOR_ARG2.some(arg => {
                            if (arg == arg2) {
                                return true;
                            }
                        });                                                                   
                        ...
                        // if (isSuggestInput == true) {
                        //     sbIfArg2 = MakeOptionSelectBox(VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid
                        //                                 , VP_CLASS_STYLE_WIDTH_15PERCENT
                        //                                 , arg2
                        //                                 , WHILE_OPERATOR_ARG2);

                        // } else {
                            sbIfArg2 = MakeVpSuggestInputText_apiblock(VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid
                                            , arg2
                                            , WHILE_OPERATOR_ARG2
                                            , VP_CLASS_STYLE_WIDTH_15PERCENT
                                            , STR_OPERATOR
                        ...
                        // var filterd_IF_OPERATOR_ARG4 = COMPARISON_OPERATOR_IF_ARG4.filter(arg => {
                        //     if (arg == 'none') {
                        //         return false;
                        //     } else {
                        //         return true;
                        //     }
                        // });
                        // var isSuggestInput = filterd_IF_OPERATOR_ARG4.some(arg => {
                        //     if (arg == arg4) {
                        //         return true;
                        //     }
                        // });
                        var sbIfArg4;
                        // if (isSuggestInput == true) {
                            // sbIfArg4 = MakeOptionSelectBox(VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid
                            //                             , VP_CLASS_STYLE_WIDTH_15PERCENT
                            //                             , arg4
                            //                             , COMPARISON_OPERATOR_IF_ARG4);
                    ...
                    // var plusButton_userInput = MakeOptionPlusButton(VP_ID_APIBLOCK_OPTION_WHILE_PLUS_USER_INPUT + uuid, '+ User Input', VP_CLASS_STYLE_MARGIN_LEFT_15PX);
                    ...
                    ifConditionListState.forEach( (condition,index) => {
                        ...
                        // if (arg2 == 'none') {
                        //     $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid).val(STR_NULL);
                        // } else {
                        //     $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid).val(arg2);
                        // }
                        $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid).val(arg2);
                        if (arg4 == '') {
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid).val(STR_NULL);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_4 + index + uuid).addClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).attr(STR_DISABLED, true);
                            $(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_5 + index + uuid).addClass(VP_CLASS_STYLE_BGCOLOR_C4C4C4);
                        } else {
                        ...
                        // RenderInputRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_1 + index + uuid);
                        // RenderInputRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_2 + index + uuid);
                        // RenderInputRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_3 + index + uuid);
                        // RenderInputRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_ARG_6 + index + uuid);
        
                        // RenderInputRequiredColor(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_WHILE_USER_INPUT + index + uuid);
                    });
