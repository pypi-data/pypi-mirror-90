define([
    ...
    vpTab.prototype.toTagString = function() {
        ...
        //     if (tabIdx == 0) {
        //         sbTagString.appendFormatLine("<div class='{0}{1}' {2} id='{3}'></div>"
        //         ,vpConst.VP_CLASS_PREFIX, "tab-page", "style='display: none;'", that._tabPages[tabIdx].get("pageid"));
        //     } else {
        //         sbTagString.appendFormatLine("<div class='{0}{1}' {2} id='{3}'></div>"
        //         ,vpConst.VP_CLASS_PREFIX, "tab-page", "style='display: block;'", that._tabPages[tabIdx].get("pageid"));
        //     }
        // }
