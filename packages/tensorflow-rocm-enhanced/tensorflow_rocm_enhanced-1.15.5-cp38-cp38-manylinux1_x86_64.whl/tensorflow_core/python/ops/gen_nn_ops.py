...
def dropout(input, rate, noise_shape, seed, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "Dropout",
        name, _ctx.post_execution_callbacks, input, rate, noise_shape, seed)
      return _result
    except _core._FallbackException:
      try:
  ...
  _execute.record_gradient(
      "Dropout", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def Dropout(input, rate, noise_shape, seed, name=None):
  return dropout(input=input, rate=rate, noise_shape=noise_shape, seed=seed, name=name)
Dropout.__doc__ = dropout.__doc__
Dropout = _doc_controls.do_not_generate_docs(_kwarg_only(Dropout))
tf_export("raw_ops.Dropout")(Dropout)


def dropout_eager_fallback(input, rate, noise_shape, seed, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function dropout
  """
  _ctx = ctx if ctx else _context.context()
  _attr_T, _inputs_T = _execute.args_to_matching_eager([input, rate], _ctx)
  ...
  _result = _execute.execute(b"Dropout", 1, inputs=_inputs_flat, attrs=_attrs,
                             ctx=_ctx, name=name)
  _execute.record_gradient(
      "Dropout", _inputs_flat, _attrs, _result, name)
  _result, = _result
...
def dropout_grad(gradients, rate, noise_shape, inputs, outputs, name=None):
  r"""TODO: add doc.
  ...
  Args:
    ...
    noise_shape: A `Tensor` of type `int32`.
    inputs: A `Tensor`. Must have the same type as `gradients`.
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DropoutGrad", name, _ctx.post_execution_callbacks, gradients, rate,
        noise_shape, inputs, outputs)
      return _result
    except _core._FallbackException:
      try:
        return dropout_grad_eager_fallback(
            gradients, rate, noise_shape, inputs, outputs, name=name,
            ctx=_ctx)
      except _core._SymbolicException:
        pass  # Add nodes to the TensorFlow graph.
      except (TypeError, ValueError):
        result = _dispatch.dispatch(
              dropout_grad, gradients=gradients, rate=rate,
                            noise_shape=noise_shape, inputs=inputs,
  ...
  try:
    _, _, _op = _op_def_lib._apply_op_helper(
        "DropoutGrad", gradients=gradients, rate=rate,
                       noise_shape=noise_shape, inputs=inputs,
                       outputs=outputs, name=name)
  except (TypeError, ValueError):
    result = _dispatch.dispatch(
  ...
  _attrs = ("T", _op._get_attr_type("T"))
  _execute.record_gradient(
      "DropoutGrad", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def DropoutGrad(gradients, rate, noise_shape, inputs, outputs, name=None):
  return dropout_grad(gradients=gradients, rate=rate, noise_shape=noise_shape, inputs=inputs, outputs=outputs, name=name)
DropoutGrad.__doc__ = dropout_grad.__doc__
DropoutGrad = _doc_controls.do_not_generate_docs(_kwarg_only(DropoutGrad))
tf_export("raw_ops.DropoutGrad")(DropoutGrad)


def dropout_grad_eager_fallback(gradients, rate, noise_shape, inputs, outputs, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function dropout_grad
  """
  _ctx = ctx if ctx else _context.context()
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, rate, inputs, outputs], _ctx)
  (gradients, rate, inputs, outputs) = _inputs_T
  noise_shape = _ops.convert_to_tensor(noise_shape, _dtypes.int32)
  _inputs_flat = [gradients, rate, noise_shape, inputs, outputs]
  _attrs = ("T", _attr_T)
...
def gelu(features, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "Gelu",
        name, _ctx.post_execution_callbacks, features)
      return _result
    except _core._FallbackException:
      try:
  ...
  _attrs = ("T", _op._get_attr_type("T"))
  _execute.record_gradient(
      "Gelu", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def Gelu(features, name=None):
  return gelu(features=features, name=name)
Gelu.__doc__ = gelu.__doc__
Gelu = _doc_controls.do_not_generate_docs(_kwarg_only(Gelu))
tf_export("raw_ops.Gelu")(Gelu)


def gelu_eager_fallback(features, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function gelu
  """
  _ctx = ctx if ctx else _context.context()
  _attr_T, (features,) = _execute.args_to_matching_eager([features], _ctx)
  _inputs_flat = [features]
...
def gelu_grad(gradients, outputs, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "GeluGrad",
        name, _ctx.post_execution_callbacks, gradients, outputs)
      return _result
    except _core._FallbackException:
      try:
        ...
        result = _dispatch.dispatch(
              gelu_grad, gradients=gradients, outputs=outputs, name=name)
        if result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
          return result
        raise
    except _core._NotOkStatusException as e:
  ...
  _attrs = ("T", _op._get_attr_type("T"))
  _execute.record_gradient(
      "GeluGrad", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def GeluGrad(gradients, outputs, name=None):
  return gelu_grad(gradients=gradients, outputs=outputs, name=name)
GeluGrad.__doc__ = gelu_grad.__doc__
GeluGrad = _doc_controls.do_not_generate_docs(_kwarg_only(GeluGrad))
tf_export("raw_ops.GeluGrad")(GeluGrad)


def gelu_grad_eager_fallback(gradients, outputs, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function gelu_grad
  """
  _ctx = ctx if ctx else _context.context()
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, outputs], _ctx)
  (gradients, outputs) = _inputs_T
