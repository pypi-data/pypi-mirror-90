...
# network plot - show relationship between different entities
...
def network02(df, entity1, entity2, relation):
    ...
    got_net = Network(height="500px", width="500px", bgcolor="white", font_color="black", notebook=True, directed=True)
    ...
    return got_net.show("KG_networks.html")
