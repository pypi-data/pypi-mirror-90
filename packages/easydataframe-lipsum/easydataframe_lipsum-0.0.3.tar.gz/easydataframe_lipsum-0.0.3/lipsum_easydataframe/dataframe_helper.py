...
def read_cell(df: DataFrame, record_name: Union[str, int], column_name: [str, int]) -> str:
    """
    This function extracts specific data from a dataframe.

    :param df: target dataframe to extract
    :param record_name: Rows name to extract, Use str if you have an index name. Use int if there is no index name
    :param column_name: Column name to extract, Use str if you have an index name. Use int if there is no index name
    :return: matched data
