...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'splunk', '0.1.1-alpha.1610111558+14c32941'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource splunk 0.1.1-alpha.1610111558+14c32941`
                """)
            else:
                raise
