...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'splunk', '0.1.1-alpha.1609965693+1f11d4c5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource splunk 0.1.1-alpha.1609965693+1f11d4c5`
                """)
            else:
                raise
