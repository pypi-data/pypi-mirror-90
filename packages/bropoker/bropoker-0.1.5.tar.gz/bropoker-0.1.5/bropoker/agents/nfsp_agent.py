...
from bropoker.agents.dqn_agent import DQNAgent
# from bropoker.agents.nfsp_agent import ReservoirBuffer
from bropoker.utils.utils import remove_illegal
...
class NFSPAgent(object):
    ''' An approximate clone of bropoker.agents.nfsp_agent that uses
