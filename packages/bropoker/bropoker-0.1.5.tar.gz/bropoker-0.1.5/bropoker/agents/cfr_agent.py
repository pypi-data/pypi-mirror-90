...
from bropoker.utils.utils import *
...
class CFRAgent():
    ...
    def eval_step(self, state):
        ...
        '''
        probs = self.action_probs(state['obs'].tobytes(), state['legal_actions'], self.average_policy)
    ...
    def get_state(self, player_id):
        ...
        return state['obs'].tobytes(), state['legal_actions']
