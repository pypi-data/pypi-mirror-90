...
import bropoker
from bropoker.envs import Env
from bropoker.games.leducholdem import Game
from bropoker.utils import *
...
class LeducholdemEnv(Env):
    ...
    def __init__(self, config):
        ...
        with open(os.path.join(bropoker.__path__[0], 'games/leducholdem/card2index.json'), 'r') as file:
