...
use crate::transport::{would_block, HTTPPersistentConnection, Listener, Listening, Read, Result};
...
pub struct Server<L: Listener> {
    ...
    connections: HashMap<Token, HTTPPersistentConnection<L::Connected>>,
    reusable: HashMap<Token, HTTPPersistentConnection<L::Connected>>,
