...
# 添加 上传到 PyPI 的命令
# PyCharm Parameters: up
# 设置 TWINE_USERNAME=lds 和 TWINE_PASSWORD 变量，但不建议设置到系统里面
# Environment variables: TWINE_USERNAME=lds;TWINE_PASSWORD=
...
setup(
    ...
    # 简单描述
    description="视频文件处理的辅助工具",
    # 详细描述
    # long_description="Django 的视频播放器程序",
    ...
    # 程序的下载地址
    download_url="https://pypi.org/project/movie_utils",
    # 作者
    author="lds",
    # 作者的邮箱地址
