...
class ConsumerMetrics(object):
    ...
    def update_metrics_map(self):
        ...
        self.consumerMetricsMap[Constants.FETCH_MESSAGE_TIMES] = self.fetchTimes / 60.0
        self.consumerMetricsMap[Constants.FETCH_MESSAGE_FAILED_TIMES] = self.fetchFailedTimes / 60.0
    ...
    def get_basic_data(self, counterType=None):
        ...
        basicData["step"] = self.consumerConfig.get_metric_falcon_step() / 1000
