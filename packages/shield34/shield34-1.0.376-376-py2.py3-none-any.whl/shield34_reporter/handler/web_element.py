...
class ElementFindElements(SeleniumMethodHandler):
    ...
    def on_successful_action(self):
        RunReportContainer.add_report_csv_row(
            WebElementHtml(
                WebElementUtils.get_elements_html(self.located_web_elements),
                WebElementUtils.get_elements_computed_css(self.located_web_elements,
                                                          DriverUtils.get_current_driver()),
                WebElementUtils.get_elements_wrapping_html(self.located_web_elements, 3)))
