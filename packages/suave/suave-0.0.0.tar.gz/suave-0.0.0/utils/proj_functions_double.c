...
//
void tophat_double(const proj_struct_double *projdata, double *u, double s, double sqr_s){
...
void piecewise_double(const proj_struct_double *projdata, double *u, double s, double sqr_s){
...
void gaussian_kernel_double(const proj_struct_double *projdata, double *u, double s, double sqr_s){
    (void) sqr_s;//to suppress the unused variable warning
    double sigma = 3.0;
...
void powerlaw_double(const proj_struct_double *projdata, double *u, double s, double sqr_s){
    (void) sqr_s;//to suppress the unused variable warning
    (void) projdata;
...
void general_r_double(const proj_struct_double *projdata, double *u, double s, double sqr_s){
    (void) sqr_s;//to suppress the unused variable warning
...
int evaluate_xi_double(int nprojbins, double *amps,
                      int nsvals, double *svals, double *xi, proj_method_t proj_method, int nsbins, double *sbins, char *projfn){
