...
//
void tophat_float(const proj_struct_float *projdata, float *u, float s, float sqr_s){
...
void piecewise_float(const proj_struct_float *projdata, float *u, float s, float sqr_s){
...
void gaussian_kernel_float(const proj_struct_float *projdata, float *u, float s, float sqr_s){
    (void) sqr_s;//to suppress the unused variable warning
    float sigma = 3.0;
...
void powerlaw_float(const proj_struct_float *projdata, float *u, float s, float sqr_s){
    (void) sqr_s;//to suppress the unused variable warning
    (void) projdata;
...
void general_r_float(const proj_struct_float *projdata, float *u, float s, float sqr_s){
    (void) sqr_s;//to suppress the unused variable warning
...
int evaluate_xi_float(int nprojbins, float *amps,
                      int nsvals, float *svals, float *xi, proj_method_t proj_method, int nsbins, float *sbins, char *projfn){
