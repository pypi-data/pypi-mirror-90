...
class Ui_postproc_editor(object):
    def setupUi(self, postproc_editor):
        ...
        self.gridLayout.addWidget(self.FrameViewer, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.VersionManagerWidget, 1, 1, 1, 2)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 533, 613))
