from orionframework.media.filterset import get_filterset_base
...
class MediaRegistry(object):
    defaults = {
        "document": {
            ...
            "service": "orionframework.media.document.services.DocumentService",
            "admin": "orionframework.media.document.admin.DocumentAdmin"
        },
        "cloud-document": {
            "serializer": "orionframework.media.cloud_document.serializers.CloudDocumentSerializer",
            "service": "orionframework.media.cloud_document.services.CloudDocumentService",
            "admin": "orionframework.media.cloud_document.admin.CloudDocumentAdmin"
        },
        "image": {
            "serializer": "orionframework.media.image.serializers.ImageSerializer",
            "service": "orionframework.media.image.services.ImageService",
