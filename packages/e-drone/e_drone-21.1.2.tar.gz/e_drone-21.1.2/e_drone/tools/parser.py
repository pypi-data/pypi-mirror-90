...
class Parser():
    ...
    def help(self):
        ...
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drone " + Fore.CYAN + "control " + Fore.WHITE + "[" + Fore.YELLOW + "roll" + Fore.WHITE + "] [" + Fore.GREEN + "pitch" + Fore.WHITE + "] [" + Fore.YELLOW + "yaw" + Fore.WHITE + "] [" + Fore.GREEN + "throttle" + Fore.WHITE + "] [" + Fore.YELLOW + "time(ms)" + Fore.WHITE + "]" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drone " + Fore.CYAN + "control " + Fore.YELLOW + "0 " + Fore.GREEN + "30 " + Fore.YELLOW + "0 " + Fore.GREEN + "0 " + Fore.YELLOW + "5000 " + Style.RESET_ALL)
        ...
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drone " + Fore.CYAN + "heading " + Fore.YELLOW + "90 " + Fore.GREEN + "45" + Style.RESET_ALL)
