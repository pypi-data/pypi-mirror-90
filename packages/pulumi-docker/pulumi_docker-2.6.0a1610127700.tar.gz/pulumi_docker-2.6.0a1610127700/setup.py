...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.6.0-alpha.1610127700+4358a28b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.6.0-alpha.1610127700+4358a28b`
                """)
            else:
                raise
