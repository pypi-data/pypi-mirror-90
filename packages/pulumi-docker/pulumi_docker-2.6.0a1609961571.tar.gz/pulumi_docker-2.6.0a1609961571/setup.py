...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.6.0-alpha.1609961571+82a64edd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.6.0-alpha.1609961571+82a64edd`
                """)
            else:
                raise
