...
from gateways.common.cs18_api_responses import (
    ...
    AccountRepositoryDetailsBranchResponse, AccountRepositoryDetailsResponse, RepositorySpaceResponse)
...
class Converters:
    ...
    @staticmethod
    def create_repository_space_response(data: dict) -> RepositorySpaceResponse:
        return RepositorySpaceResponse(repository_name=data['name'],
                                       repository_type=data['repository_type'],
                                       repository_url=data['repository_url'],
                                       branch=data['branch'])
