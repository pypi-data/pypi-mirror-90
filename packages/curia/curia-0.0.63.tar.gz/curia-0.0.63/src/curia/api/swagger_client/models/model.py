...
class Model(object):
    ...
    def __init__(self, id=None, name=None, type=None, outcome_type=None, feature_store=None, description=None, project_id=None, endpoints=None, project=None, cohorts=None, model_jobs=None, user_favorites=None, model_datasets=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
