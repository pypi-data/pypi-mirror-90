...
""" skipped modules used as default by :func:`module_name` and :func:`stack_var` """
...
def stack_var(name: str, *skip_modules: str, scope: str = '', depth: int = 1) -> Optional[Any]:
    ...
    :return:                    The variable value of a deeper level within the call stack or None if the variable
                                was not found.
    """
