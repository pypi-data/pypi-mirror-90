...
from polyaxon.polyflow import dags, refs
...
class V1Dag(BaseConfig, polyaxon_sdk.V1Dag):
    ...
    def process_components(self, inputs=None):
        ...
        for op in self.operations:
            ...
            for g_context in refs.GLOBALS_CONTEXTS:
            ...
            self._context["ops.{}.{}".format(op_name, refs.INPUTS)] = V1IO(
                name="inputs", iotype=types.DICT, value={}, is_optional=True
            )
            self._context["ops.{}.{}".format(op_name, refs.OUTPUTS)] = V1IO(
                name="outputs", iotype=types.DICT, value={}, is_optional=True
            )
            self._context["ops.{}.{}".format(op_name, refs.GLOBALS)] = V1IO(
                name="globals", iotype=types.STR, value="", is_optional=True
            )
            self._context["ops.{}.{}".format(op_name, refs.ARTIFACTS)] = V1IO(
                name="artifacts", iotype=types.STR, value="", is_optional=True
            )
