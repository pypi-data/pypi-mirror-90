...
class BaseCompetency(BaseMoodle):
    def add_competency_to_course(self, **kwargs):
        data = self.moodle.get('core_competency_add_competency_to_course',
                               **kwargs)
        return data

    def add_competency_to_plan(self, **kwargs):
        data = self.moodle.get('core_competency_add_competency_to_plan',
                               **kwargs)
        return data

    def add_competency_to_template(self, **kwargs):
        data = self.moodle.get('core_competency_add_competency_to_template',
                               **kwargs)
        return data

    def add_related_competency(self, **kwargs):
        data = self.moodle.get('core_competency_add_related_competency',
                               **kwargs)
        return data
    ...
    def competency_framework_viewed(self, **kwargs):
        data = self.moodle.get('core_competency_competency_framework_viewed',
                               **kwargs)
        return data
    ...
    def count_competencies_in_course(self, **kwargs):
        data = self.moodle.get('core_competency_count_competencies_in_course',
                               **kwargs)
        return data
    ...
    def count_competency_frameworks(self, **kwargs):
        data = self.moodle.get('core_competency_count_competency_frameworks',
                               **kwargs)
        return data
    ...
    def create_competency_framework(self, **kwargs):
        data = self.moodle.get('core_competency_create_competency_framework',
                               **kwargs)
        return data
    ...
    def delete_competency_framework(self, **kwargs):
        data = self.moodle.get('core_competency_delete_competency_framework',
                               **kwargs)
        return data
    ...
    def delete_user_evidence(self, **kwargs):
        data = self.moodle.get('core_competency_delete_user_evidence',
                               **kwargs)
        return data
    ...
    def grade_competency_in_course(self, **kwargs):
        data = self.moodle.get('core_competency_grade_competency_in_course',
                               **kwargs)
        return data

    def grade_competency_in_plan(self, **kwargs):
        data = self.moodle.get('core_competency_grade_competency_in_plan',
                               **kwargs)
        return data
    ...
    def list_competencies_in_template(self, **kwargs):
        data = self.moodle.get('core_competency_list_competencies_in_template',
                               **kwargs)
        return data

    def list_competency_frameworks(self, **kwargs):
        data = self.moodle.get('core_competency_list_competency_frameworks',
                               **kwargs)
        return data

    def list_course_competencies(self, **kwargs):
        data = self.moodle.get('core_competency_list_course_competencies',
                               **kwargs)
        return data
    ...
    def list_plan_competencies(self, **kwargs):
        data = self.moodle.get('core_competency_list_plan_competencies',
                               **kwargs)
        return data
    ...
    def move_down_competency(self, **kwargs):
        data = self.moodle.get('core_competency_move_down_competency',
                               **kwargs)
        return data
    ...
    def plan_cancel_review_request(self, **kwargs):
        data = self.moodle.get('core_competency_plan_cancel_review_request',
                               **kwargs)
        return data
    ...
    def read_competency_framework(self, **kwargs):
        data = self.moodle.get('core_competency_read_competency_framework',
                               **kwargs)
        return data
    ...
    def remove_competency_from_course(self, **kwargs):
        data = self.moodle.get('core_competency_remove_competency_from_course',
                               **kwargs)
        return data

    def remove_competency_from_plan(self, **kwargs):
        data = self.moodle.get('core_competency_remove_competency_from_plan',
                               **kwargs)
        return data
    ...
    def remove_related_competency(self, **kwargs):
        data = self.moodle.get('core_competency_remove_related_competency',
                               **kwargs)
        return data
    ...
    def reorder_course_competency(self, **kwargs):
        data = self.moodle.get('core_competency_reorder_course_competency',
                               **kwargs)
        return data

    def reorder_plan_competency(self, **kwargs):
        data = self.moodle.get('core_competency_reorder_plan_competency',
                               **kwargs)
        return data

    def reorder_template_competency(self, **kwargs):
        data = self.moodle.get('core_competency_reorder_template_competency',
                               **kwargs)
        return data
    ...
    def set_parent_competency(self, **kwargs):
        data = self.moodle.get('core_competency_set_parent_competency',
                               **kwargs)
        return data

    def template_has_related_data(self, **kwargs):
        data = self.moodle.get('core_competency_template_has_related_data',
                               **kwargs)
        return data
    ...
    def unlink_plan_from_template(self, **kwargs):
        data = self.moodle.get('core_competency_unlink_plan_from_template',
                               **kwargs)
        return data
    ...
    def update_competency_framework(self, **kwargs):
        data = self.moodle.get('core_competency_update_competency_framework',
                               **kwargs)
        return data
    ...
    def user_competency_plan_viewed(self, **kwargs):
        data = self.moodle.get('core_competency_user_competency_plan_viewed',
                               **kwargs)
        return data
    ...
    def user_competency_start_review(self, **kwargs):
        data = self.moodle.get('core_competency_user_competency_start_review',
                               **kwargs)
        return data

    def user_competency_stop_review(self, **kwargs):
        data = self.moodle.get('core_competency_user_competency_stop_review',
                               **kwargs)
        return data

    def user_competency_viewed(self, **kwargs):
        data = self.moodle.get('core_competency_user_competency_viewed',
                               **kwargs)
        return data
