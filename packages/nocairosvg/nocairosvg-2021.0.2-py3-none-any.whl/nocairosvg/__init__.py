...
def svg2svg(bytestring: Optional[bytes] = None,
...
def svg2png(bytestring: Optional[bytes] = None,
file_obj: Optional[FileIO] = None, url: Optional[str] = None, dpi: int = 96,
parent_width: Optional[int] = None, parent_height: Optional[int] = None,
scale: float = 1, unsafe: bool = False, background_color: Optional[str] = None,
negate_colors: bool = False, invert_images: bool = False, write_to: Union[str,
...
def svg2ps(bytestring: Optional[bytes] = None,
file_obj: Optional[FileIO] = None, url: Optional[str] = None, dpi: int = 96,
parent_width: Optional[int] = None, parent_height: Optional[int] = None,
scale: float = 1, unsafe: bool = False, background_color: Optional[str] = None,
negate_colors: bool = False, invert_images: bool = False, write_to: Union[str,
...
def svg2eps(bytestring: Optional[bytes] = None,
file_obj: Optional[FileIO] = None, url: Optional[str] = None, dpi: int = 96,
parent_width: Optional[int] = None, parent_height: Optional[int] = None,
scale: float = 1, unsafe: bool = False, background_color: Optional[str] = None,
negate_colors: bool = False, invert_images: bool = False, write_to: Union[str,
...
negate_colors: bool = False, invert_images: bool = False, write_to: Union[str,
FileIO,
None] = None, output_width: Optional[int] = None, output_height: Optional[
int] = None, ext: str = "png", transparent: bool = True) -> Optional[bytes]:
	"""Convert an SVG to an SVG
...
file_obj: Optional[FileIO] = None, url: Optional[str] = None) -> str:
...
def colour2Tuple(colour: Optional[str]) -> Tuple[int, int, int, int]:
	...
	if colour is None or colour not in colours:
		return (0, 0, 0, 0)
	return int(colours[colour][0] * 255), int(colours[colour][1] * 255), int(
		colours[colour][2] * 255), int(colours[colour][3] * 255) # yapf: disable
