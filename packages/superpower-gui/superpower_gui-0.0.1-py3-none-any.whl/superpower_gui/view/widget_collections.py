# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/view.widget_collections.ipynb (unless otherwise specified).

__all__ = ['WidgetContainer', 'Box', 'HBox', 'VBox', 'WidgetList', 'WidgetRow', 'WidgetColumn', 'SelectionContainer',
           'SelectionBox', 'SelectionVBox', 'SelectionHBox', 'TabAcc', 'Tab', 'Accordion', 'LogAccordion']
...
from ..model.model_collections import Collection, Selection, CollectionList, CollectionArray
from .widgets import Widget, FloatText, IntText, Label, Grid
from ..globals import HANDLER, LogHandlerWidget
...
# Cell
class WidgetList(CollectionList, WidgetContainer, ipyw.Box):
    pass
...
class TabAcc(Collection, Widget, ipyw.widget_selectioncontainer._SelectionContainer):
    ...
    children = ipyw.trait_types.TypedTuple(trait=Instance(Widget), help="List of widget children").tag(sync=True, **ipyw.widget.widget_serialization)
    ...
    def _add_child(self, child):
        ...
        self.set_title(self.size - 1, child.name)
...
class LogAccordion(Accordion):
    ...
    children = ipyw.trait_types.TypedTuple(trait=Instance(LogHandlerWidget), help="List of widget children").tag(sync=True, **ipyw.widget.widget_serialization)