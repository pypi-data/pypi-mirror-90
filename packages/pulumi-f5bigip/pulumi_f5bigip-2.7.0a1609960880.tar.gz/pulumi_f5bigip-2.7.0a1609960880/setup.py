...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '2.7.0-alpha.1609960880+7657c6c7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 2.7.0-alpha.1609960880+7657c6c7`
                """)
            else:
                raise
