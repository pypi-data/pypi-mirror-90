...
def create_html(gantt: Gantt, svg_input_dir:str, embed_css: bool= True) -> str:
   ...
   js_data = pkg_resources.resource_string(__name__, 'assets/myScripts.js')
   # js = open('./rendering/assets/myScripts.js', 'r')
   # js_data = js.read()


   css_string = pkg_resources.resource_string(__name__, 'assets/styles.css')
   css_data= ""
   if embed_css: css_data = css_string
