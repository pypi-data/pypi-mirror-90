...
def swapdf(argv):
    ...
    if args.open and args.quit:
        exit("ERROR: you can't give both -o/--open and -z/--quit arguments")
    ...
    if args.open or not args.quit and ask("open target file {target!r} for check and print? (o=open, q=quit) --> ", "oq") == "o":
