...
**Test AverageSingleDistributionStrategy**
...
def test_average_single_distribution_strategy_call() -> None:
    """
    Test the call method of AverageSingleDistributionStrategy class
    """
    uncertainty_metric = VarianceSingleDistribution()
    strategy = AverageSingleDistributionStrategy(
