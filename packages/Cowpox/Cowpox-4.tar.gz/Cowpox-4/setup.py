...
setuptools.setup(
        ...
        py_modules = [],
        install_requires = ['aridity>=45', 'chromalog>=1.0.4', 'Cython>=0.29.20', 'diapyr>=18', 'jproperties>=2.1.0', 'lagoon>=21', 'networkx>=2.4', 'packaging>=20.4', 'setuptools>=44.1.1'],
        package_data = {'': ['*.pxd', '*.pyx', '*.pyxbld', '*.arid', '*.aridt', '*.patch', '*.mk', '*.txt']},
        scripts = [],
        entry_points = {'console_scripts': ['Cowpox=cowpox.cowpox:main_Cowpox', 'Cowpox-servant=cowpox.servant:main_Cowpox_servant']},
        **ext_modules())
