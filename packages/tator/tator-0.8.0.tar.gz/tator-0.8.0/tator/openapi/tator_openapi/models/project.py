...
class Project(object):
    ...
    def __init__(self, id=None, name=None, num_files=None, organization=None, permission=None, size=None, summary='', thumb=None, usernames=None, local_vars_configuration=None):  # noqa: E501
