...
class Ui_Calculator(object):
    ...
    def retranslateUi(self, Calculator):
        Calculator.setWindowTitle(QCoreApplication.translate("Calculator",
                                                             u"\u6570\u5b66\u8ba1\u7b97\u5668", None))
        self.pbtn_start.setText(QCoreApplication.translate("Calculator",
                                                           u"\u5f00\u59cb\u8fd0\u7b97", None))
        self.lb_title.setText(QCoreApplication.translate("Calculator",
                                                         u"\u6570\u5b66\u8ba1\u7b97\u5668", None))
        self.cb_mode.setItemText(0, QCoreApplication.translate("Calculator",
                                                               u"\u5206\u89e3\u8d28\u56e0\u6570", None))
        self.cb_mode.setItemText(1, QCoreApplication.translate("Calculator",
                                                               u"\u5206\u5f0f\u901a\u5206", None))
        self.cb_mode.setItemText(2, QCoreApplication.translate("Calculator",
                                                               u"\u6574\u5f0f\u5927\u9664\u6cd5", None))
        self.cb_mode.setItemText(3, QCoreApplication.translate("Calculator",
                                                               u"\u591a\u9879\u5f0f\u5c55\u5f00", None))
        self.cb_mode.setItemText(4, QCoreApplication.translate("Calculator",
                                                               u"\u591a\u9879\u5f0f\u56e0\u5f0f\u5206\u89e3", None))
        self.cb_mode.setItemText(5, QCoreApplication.translate("Calculator",
                                                               u"\u7ed8\u5236\u51fd\u6570\u56fe\u50cf", None))
        self.cb_mode.setItemText(6, QCoreApplication.translate("Calculator",
                                                               u"\u6c42\u89e3\u65b9\u7a0b/\u65b9\u7a0b\u7ec4", None))
...
class Calculator(QMainWindow, Ui_Calculator):
    ...
    def start_calculate(self):
        ...
        if self.mode == "分解质因数":
            ...
            self.tb_result.setText(str(self.expression) + " = " + str(expand(self.expression)))

        elif self.mode == "多项式因式分解":
            self.tb_result.setText(str(self.expression) + " = " + str(factor(self.expression)))

        elif self.mode == "分式通分":
            self.tb_result.setText(str(self.expression) + " = " + str(together(self.expression)))
