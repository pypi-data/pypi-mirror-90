...
from ...constraints import (Constraint, MomentAmbiguousExtremumAffineConstraint,
...
class RandomExtremumAffine(ExtremumBase, UncertainExpression, Expression):
    ...
    def __init__(self, expressions):
        ...
        perturbations = tuple(set(x.perturbation for x in expressions))
        ...
        if not universe.distributional:
