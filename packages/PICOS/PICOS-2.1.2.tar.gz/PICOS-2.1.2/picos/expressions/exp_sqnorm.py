...
class SquaredNorm(QuadraticExpression):
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, AffineExpression):
            if not other.constant:
                raise TypeError("You may only multiply a squared norm with a "
                    "constant term.")
            ...
            result = SquaredNorm(self._x*value**0.5)
    ...
    def __truediv__(self, other):
        ...
        if isinstance(other, AffineExpression):
            if not other.constant:
                raise TypeError("You may only divide a squared norm by a "
                    "constant term.")
    ...
    def fullroot(self):
        ...
        Overrides :meth:`~picos.expressions.QuadraticExpression.fullroot` of
    ...
    def is_squared_norm(self):
        ...
        Overrides :meth:`~picos.expressions.QuadraticExpression.is_squared_norm`
        of :class:`~picos.expressions.QuadraticExpression`.
        """
        return True
    ...
    def is0(self):
        ...
        Overrides :meth:`~picos.expressions.QuadraticExpression.is0` of
        :class:`~picos.expressions.QuadraticExpression`.
        """
        return self._x.is0
