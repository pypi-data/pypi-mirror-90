...
"""
    ...
    The version of the OpenAPI document: 2020.12.26
...
class Application(object):
    ...
    def service_account_required(self):
        ...
        If service_account_enabled is set to true, a service account will be created. If service_account enabled is set to false, no service account will be created.   # noqa: E501
