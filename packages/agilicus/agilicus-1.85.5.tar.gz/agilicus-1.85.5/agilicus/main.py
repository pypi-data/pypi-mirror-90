...
def list_audit_records(ctx, **kwargs):
    ...
    if output_format == "json":
        ...
        print(audits.format_audit_list_as_text(ctx, records))
...
@click.option("--name_resolution", default=None)
@click.option(
    "--service_type", type=click.Choice(["vpn", "agent", "internet"]), default=None
)
@click.option("--protocol", default=None)
@click.option("--connector_id", default=None)
@click.pass_context
...
@click.option("--service_account_required", is_flag=True)
@click.pass_context
...
@click.option("--input_is_list", default=None, type=bool)
@click.option("--org-id", default=None)
@click.pass_context
...
def list_connectors(ctx, **kwargs):
    ...
    table = PrettyTable(["id", "name", "org_id", "type", "application_services"])
...
@click.option("--name", default=None)
@click.option("--connection_uri", default=None)
@click.option("--max-number_connections", type=int, default=None)
@click.pass_context
