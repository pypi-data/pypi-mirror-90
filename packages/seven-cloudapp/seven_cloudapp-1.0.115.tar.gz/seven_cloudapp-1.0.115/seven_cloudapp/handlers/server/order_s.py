...
:LastEditTime: 2020-12-30 12:17:05
    ...
    def post_async(self):
        ...
        for i in range(1, data_total):
            ...
            if order_no and express_no and express_company:
                ...
                PrizeOrderModel().update_table(update_sql, "order_no=%s and act_id=%s", params)
                PrizeRosterModel().update_table("order_status=1", "order_no=%s and act_id=%s", [order_no, act_id])
