...
class MessageInfo:
    ...
    def get_field_list(self):
        return ['id', 'rank', 'title', 'news_type', 'content', 'is_popup_window', 'popup_window_position', 'popup_window_frequency', 'popup_window_date_start', 'popup_window_date_end', 'is_release', 'release_date_start', 'release_date_end', 'create_date', 'modify_date']
