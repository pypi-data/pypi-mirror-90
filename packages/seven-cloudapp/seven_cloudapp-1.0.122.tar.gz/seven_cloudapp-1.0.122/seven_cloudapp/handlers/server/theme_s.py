...
:LastEditTime: 2021-01-04 14:08:51
...
class ThemeListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        for dict_info in dict_list:
            dict_info["client_json"] = json.loads(dict_info["client_json"]) if dict_info["client_json"] else []
            dict_info["server_json"] = json.loads(dict_info["server_json"]) if dict_info["server_json"] else []
