...
:LastEditTime: 2020-12-25 16:45:21
...
class LoginHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        is_gear = int(self.get_param("is_gear", 0))
        ...
        if is_machine == 1 or is_gear == 1:
            machine_info_list = MachineInfoModel().get_list("act_id=%s", params=[act_id])
        ...
        if is_machine == 1:
            machine_value_list = MachineValueModel().get_dict_list("open_id=%s", params=open_id)
