...
:LastEditTime: 2020-12-24 18:00:43
...
class ThemeListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        for info in theme_info_list:
            ...
            theme_info["client_json"] = self.json_loads(info.client_json)
            theme_info["server_json"] = self.json_loads(info.server_json)
...
class SkinListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        for info in skin_info_list:
            ...
            skin_info["client_json"] = self.json_loads(info.client_json)
            skin_info["server_json"] = self.json_loads(info.server_json)
