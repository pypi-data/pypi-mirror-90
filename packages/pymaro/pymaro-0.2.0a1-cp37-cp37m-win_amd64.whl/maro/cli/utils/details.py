...
def save_job_details(cluster_name: str, job_name: str, job_details: dict, sync: bool = True) -> None:
    ...
    if sync:
        _sync_job_details(cluster_name=cluster_name, job_name=job_name, job_details=job_details)
...
def load_job_details(cluster_name: str, job_name: str, sync: bool = False) -> dict:
    ...
    if sync:
        _sync_job_details(cluster_name=cluster_name, job_name=job_name, job_details=details)
    return details
