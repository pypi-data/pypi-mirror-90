...
class Graph:
    ...
    def __update_nodes(self, file_path, client):
        ...
        def format_node():
            nonlocal symbol_type, file_path, scope, function_name
    ...
    def __build_json(self):
        ...
        main["nodes"] = graph_nodes
        main["edges"] = graph_edges
        data["main"] = main
    ...
    def start_frontend(self):
        print(CURRENT_DIR_PATH + FRONT_END_PATH)
        os.chdir(CURRENT_DIR_PATH + FRONT_END_PATH + 'build')
          
        bash_command = "open http://localhost:8000"
