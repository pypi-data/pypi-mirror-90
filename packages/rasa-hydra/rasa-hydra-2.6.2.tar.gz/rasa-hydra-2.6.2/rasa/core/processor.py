...
class MessageProcessor:
    ...
    def get_asr_threshold(self):
        """Return the ASR confidence threshold"""
        asr_fallback_policy = self.policy_ensemble.look_up_policy(AsrFallbackPolicy)
    ...
    def create_metadata(
        ...
        metadata["asr_threshold"] = self.get_asr_threshold()
