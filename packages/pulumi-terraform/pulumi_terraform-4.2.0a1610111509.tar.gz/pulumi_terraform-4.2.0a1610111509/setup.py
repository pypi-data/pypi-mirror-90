...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '4.2.0-alpha.1610111509+9e5f7c95'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 4.2.0-alpha.1610111509+9e5f7c95`
                """)
