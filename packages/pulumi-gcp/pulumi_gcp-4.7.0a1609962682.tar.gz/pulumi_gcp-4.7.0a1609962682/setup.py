...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.7.0-alpha.1609962682+e77f99bd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.7.0-alpha.1609962682+e77f99bd`
                """)
            else:
                raise
