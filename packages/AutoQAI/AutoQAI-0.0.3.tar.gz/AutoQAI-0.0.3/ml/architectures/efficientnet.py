...
if __name__ == '__main__':
    ...
    print(layer1.get_config()['activation'] == 'softmax' or layer1.get_config()['activation'] == 'sigmoid')
    print(layer1.get_config()['activation'] == 'softmax')
    print(layer1.get_config()['activation'] == 'sigmoid')
    print(output)
